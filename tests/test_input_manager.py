...
def test_validate_data_valid(mock_input_manager: InputManager, mock_metadata,
...
def test_validate_data_invalid(mock_input_manager: InputManager, mock_metadata,
                               input_manager_original_method_states: Dict[str, Callable], ):
...
def test_validate_data_eager_termination(mock_input_manager: InputManager, mock_metadata,
                                         input_manager_original_method_states: Dict[str, Callable], ):
