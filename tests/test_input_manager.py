...
def test_delete_data_with_invalid_data_address(simple_pool_and_meta, mocker) -> None:
...
def test_delete_data_metadata_not_found(simple_pool_and_meta, mocker) -> None:
