...
def test_calc_requirements():
    ...
    actual = RUFAS.routines.animal.ration.calf_ration.CalfRationManager.calc_requirements(calf, feed, temp, animal_intake)
    expected = {'ne_maint': {'op': '=', 'val': 2.719558787744806}, 'me_maint': {'op': '=', 'val': 1.1010359464553872}, 'bio_val': {'op': '=', 'val': 0.023}, 'endo_urine_N': {'op': '=', 'val': 6.324555320336759}, 'meta_fecal_N': {'op': '=', 'val': 7.1000000000000005}, 'adp_maint': {'op': '=', 'val': 3603.6019892219456}, 'me_gain': {'op': '=', 'val': -0.10103594645538716}, 'ne_gain': {'op': '=', 'val': -0.16557326346944443}, 'energy_allow_gain': {'op': '=', 'val': 0}, 'adp_allow_gain': {'op': '=', 'val': -0.4407438603835359}, 'live_weight_change': {'op': '=', 'val': -0.4407438603835359}}
    assert actual == expected
...
def test_calc_intake():
    ...
    actual = RUFAS.routines.animal.ration.calf_ration.CalfRationManager.calc_intake(calf, feed, wean_day, wean_length, milk_type)
    expected = {'whole_milk_intake': 0.001, 'milk_replacer_intake': 0.0, 'starter_intake': -0.2379166, 'wean_start': 89, 'milk_reduction': 5, 'milk_intake_wean': 0.0005454545454545455, 'dm_intake': -0.2369166, 'me_intake': -0.13008446328000003, 'cp_intake': -0.0023691660000000002, 'adp_intake': 749.2402389701692, 'milk_me_proportion': -0.007379820585750122, 'starter_me_proportion': 1.00737982058575, 'milk_proportion': -0.004220894610170837, 'starter_proportion': 1.004220894610171}

    assert actual == expected
    
    milk_type = 'not_whole'
    actual = RUFAS.routines.animal.ration.calf_ration.CalfRationManager.calc_intake(calf, feed, wean_day, wean_length, milk_type)
    expected = {'whole_milk_intake': 0.0, 'milk_replacer_intake': 0.00015, 'starter_intake': -0.2379166, 'wean_start': 89, 'milk_reduction': 5, 'milk_intake_wean': 8.18181818181818e-05, 'dm_intake': -0.2377666, 'me_intake': -0.13090046328000002, 'cp_intake': -0.002377666, 'adp_intake': 749.8864432599029, 'milk_me_proportion': -0.001100072500828203, 'starter_me_proportion': 1.0011000725008283, 'milk_proportion': -0.0006308707783178966, 'starter_proportion': 1.000630870778318}
...
def test_ration_to_use(mock_user_defined_ration_manager: UserDefinedRationManager):
    ...
    result = RUFAS.routines.animal.ration.user_defined_ration.UserDefinedRationManager.ration_to_use(
