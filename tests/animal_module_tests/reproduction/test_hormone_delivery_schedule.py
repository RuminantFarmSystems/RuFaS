...
def test_get_schedule() -> None:
    ...
    assert HormoneDeliverySchedule.get_schedule("invalid_category", "some_protocol") is None
...
def test_get_adjusted_schedule() -> None:
    ...
    assert HormoneDeliverySchedule.get_adjusted_schedule("invalid_category", "some_protocol", start_day) is None
