...
@pytest.mark.parametrize(
    "initial_states, expected_states",
    [
...
def test_repro_state_manager_init(
    initial_states: set[ReproStateEnum] | None, expected_states: set[ReproStateEnum]
) -> None:
    """
...
@pytest.mark.parametrize(
    "initial_states, state_to_enter, keep_existing, expected_states, expected_exception",
    [
        ...
        (
            ...
            ReproStateEnum.WAITING_FULL_ED_CYCLE,
            True,
            {ReproStateEnum.PREGNANT, ReproStateEnum.WAITING_FULL_ED_CYCLE},
            None,
        ),
...
@pytest.mark.parametrize(
    "initial_states, state_to_exit, expected_states, expected_exception",
    [
...
@pytest.mark.parametrize(
    "initial_states, state_to_check, expected_result",
    [
...
@pytest.mark.parametrize(
    "initial_states, expected_result",
    [
...
@pytest.mark.parametrize(
    "initial_states, states_to_check, expected_result",
    [
        ...
        (
            {ReproStateEnum.PREGNANT, ReproStateEnum.WAITING_FULL_ED_CYCLE},
            {ReproStateEnum.PREGNANT, ReproStateEnum.FRESH},
            True,
        ),
        # Test with multiple active states, checking for multiple states none of which are active
        (
            {ReproStateEnum.PREGNANT, ReproStateEnum.WAITING_FULL_ED_CYCLE},
            {ReproStateEnum.FRESH, ReproStateEnum.IN_OVSYNCH},
            False,
        ),
    ],
)
...
def test_repro_state_manager_str(initial_states: set[ReproStateEnum] | None) -> None:
    """
