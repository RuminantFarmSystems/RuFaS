...
def test_lactating_cow_manure(days_in_milk: int,
                              milk_protein: float,
    ...
    manure_nitrogen = (
                          20.3
                          + 0.654
                          * (dry_matter_intake * 1000)
                          * (CP_concentration * 0.16)
                          / 100
                      ) * 0.001
    ...
    observed = ManureExcretionCalculator._lactating_cow_manure(days_in_milk,
                                                               milk_protein,
    ...
    mock_phosphorus_excretion.assert_called_once_with(daily_milk_production=daily_milk_production,
                                                      total_manure_excreted=total_manure_excreted,
                                                      fecal_phosphorus=fecal_phosphorus,
                                                      urine_phosphorus_required=urine_phosphorus_required)
...
def test_cow_manure_dry(body_weight: float,
    ...
    mock_dry_cow_manure.assert_called_once_with(body_weight,
                                                daily_milk_production,
                                                fecal_phosphorus,
                                                urine_phosphorus_required,
                                                nutrient_amounts,
