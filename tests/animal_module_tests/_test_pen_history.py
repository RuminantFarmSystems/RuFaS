...
@pytest.mark.parametrize(
    ...
    [
        (1, 10, 1, ["class1", "class2"]),
        (5, 20, 2, ["class3"]),
        (100, 200, 3, ["class1", "class2", "class3"]),
    ],
)
def test_pen_history_initialization(start_date: int, end_date: int, pen: int, classes_in_pen: list[str]) -> None:
    """
