...
def test_handle_failed_constraints_cow(mocker: MockerFixture) -> None:
    ...
    assert om.variables_pool[
        "RationManager.handle_failed_constraints.failed_constraint_summary_for_pen_0"
    ]["values"] == [
        {
            "simulation day": 44,
            "reattempt number": 4,
...
def test_handle_failed_constraints_heifer(mocker: MockerFixture) -> None:
    ...
    mock_make_ration_from_solution.assert_called_once_with(
        mock_heifer_available_feeds, mock_heifer_solution
    )

    assert om.variables_pool[
        "RationManager.handle_failed_constraints.failed_constraint_summary_for_pen_1"
    ]["values"] == [
        {
            "simulation day": 22,
            "reattempt number": 2,
