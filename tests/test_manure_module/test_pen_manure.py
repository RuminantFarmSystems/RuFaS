...
def test_pen_manure_init() -> None:
    ...
    expected_total_ammoniacal_nitrogen = (
                                                 (animal_manure[
                                                      'total_ammoniacal_nitrogen_concentration'] / num_animals) *
                                                 animal_manure['manure_mass'] * GeneralConstants.KG_TO_GRAMS /
                                                 ManureConstants.MANURE_DENSITY
                                         ) * GeneralConstants.GRAMS_TO_KG

    expected_urine_ammoniacal_nitrogen = animal_manure['urine_nitrogen'] * ManureConstants.URINE_TAN_FACTOR
    ...
    assert manure.methane == approx(animal_manure['methane'] * GeneralConstants.GRAMS_TO_KG)
