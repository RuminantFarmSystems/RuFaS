...
# def test_3_NOP_methane_mitigation(mocker: MockerFixture):
#     # Arrange 
...
#     feed = mock_feed
#     methane_mitigation_method = '3-NOP'
#     methane_mitigation_additive_amount = 70.0
    
#     expected_result = -30.8 - 0.226 * (methane_mitigation_additive_amount - 70.5) + 0.906 * (
#         ration_formulation['NDF'] - 32.9) + 3.871 * (ration_formulation['EE'] - 4.2) - 0.337 * (ration_formulation['starch'] - 21.1)
    
#     mock_ration_formulation.__getitem__.side_effect = lambda key: {
#         'NDF': 36.7,
#         'EE': 4.5,
#         'starch': 19.7 
#     }.get(key, 0.0)
...
#     # Act
#     result = methane_mitigation(ration_formulation, feed, methane_mitigation_method, methane_mitigation_additive_amount)
...
def test_lactating_cow_manure_calculations(methane_model: str, methane_mitigation_method: str, mocker: MockerFixture) -> None:
    ...
    if dry_matter_intake != 0:
        ...
        methane_yield_reduction = methane_mitigation(
            mock_ration_formulation,
            mock_feed,
            methane_mitigation_method,
            methane_mitigation_additive_amount
        )
    print(methane_yield_reduction)
    print(methane_yield_original)
...
#     total_manure_excreted = 130.0 
#     urine_urea_nitrogen_concentration = 0.4
#     total_ammoniacal_nitrogen_concentration = 2.0 
#     urine = 20.0 
#     urine_nitrogen = 10.0 
#     manure_nitrogen = 0.8 
#     fecal_solids = 16.0 
#     degradable_volatile_solids = 14.0 
#     non_degradable_volatile_solids = 1.6 
#     potassium = 300.0  
