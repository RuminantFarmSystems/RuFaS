...
from RUFAS.data_structures.nutrient_request import NutrientRequestResults
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            4.0,
            0.5,
        ),  # Switch organic and inorganic fractions
        ...
        (
            ...
            4.0,
            0.9,
        ),  # Test other extremes of fractions
    ],
)
def test_nutrient_request_results_init(
    ...
    ammonium_nitrogen_fraction: float,
...
@pytest.mark.parametrize(
    "field_to_test_negative",
    ["nitrogen", "phosphorus", "total_manure_mass", "dry_matter"],
)
def test_nutrient_request_results_init_with_negative_non_fractional_fields(
    field_to_test_negative: str,
) -> None:
    """
...
def test_nutrient_request_results_init_with_out_of_range_fractional_fields(
    field_to_test_out_of_range: str,
) -> None:
    """
    Unit test for the __post_init__ method in the NutrientRequestResults class.
