...
def test_manure_manager_output_handler_init(mocker: MockFixture) -> None:
    """Unit test for __init__() in manure_manager_output_handler.py."""
    # Arrange
    patch_for_empty_main_output_directory = mocker.patch(
            'RUFAS.routines.manure.output_handler.manure_manager_output_handler.'
            'ManureManagerOutputHandler.empty_main_output_directory',
            return_value=None
    )
    ...
    # Assert
    assert manure_manager_output_handler._df is None
    patch_for_empty_main_output_directory.assert_called_once()


def test_property_data(mocker: MockFixture) -> None:
    """Unit test for property data() in manure_manager_output_handler.py."""
    # Arrange
    mocker.patch(
            'RUFAS.routines.manure.output_handler.manure_manager_output_handler.'
    ...
    manure_manager_output_handler = ManureManagerOutputHandler()
    manure_manager_output_handler._df = expected_data = mocker.MagicMock()

    # Act
    actual_data = manure_manager_output_handler.data
...
def test_process_pen(mocker: MockFixture) -> None:
    ...
    mock_manure_manager_pen.num_animals = num_animals = 2
...
def test_append_daily_update_output_for_pen(mocker: MockFixture) -> None:
    ...
    mock_manure_manager_pen.manure = mock_pen_manure
    ...
    patch_for_process_pen = mocker.patch(
            'RUFAS.routines.manure.output_handler.manure_manager_output_handler.'
            'ManureManagerOutputHandler._process_pen',
    ...
    patch_for_append_row = mocker.patch(
            'RUFAS.routines.manure.output_handler.manure_manager_output_handler.'
            'ManureManagerOutputHandler._append_row',
    ...
    # Act
    manure_manager_output_handler.append_daily_update_output_for_pen(
            simulation_day=simulation_day,
            data=mock_data
    )

    # Assert
    patch_for_process_pen.assert_called_once_with(mock_manure_manager_pen)
    ...
    assert manure_manager_output_handler._df == mock_dataframe_with_appended_row
...
def test_append_row(instance_df_exists: bool,
    ...
    """Unit test for _append_row() in manure_manager_output_handler.py."""
    # Arrange
    ...
    if instance_df_exists:
        manure_manager_output_handler._df = mock_instance_df
    else:
        manure_manager_output_handler._df = None

    # Act
    actual_df = manure_manager_output_handler._append_row(mock_row_data)
...
def test_sort_by(instance_df_exists: bool,
                 mocker: MockFixture) -> None:
    """Unit test for sort_by() in manure_manager_output_handler.py."""
    # Arrange
    mocker.patch(
            'RUFAS.routines.manure.output_handler.manure_manager_output_handler.'
            'ManureManagerOutputHandler.__init__',
    ...
    # Act
    manure_manager_output_handler.sort_by(mock_sort_columns)
...
def test_move_columns_to_front(instance_df_exists: bool,
                               mocker: MockFixture) -> None:
    """Unit test for move_columns_to_front() in manure_manager_output_handler.py."""
    # Arrange
    mocker.patch(
            'RUFAS.routines.manure.output_handler.manure_manager_output_handler.'
            'ManureManagerOutputHandler.__init__',
    ...
    # Act
    manure_manager_output_handler.move_columns_to_front(mock_columns_to_move)
...
def test_sort_by_pen_id_and_simulation_day(mocker: MockFixture) -> None:
    """Unit test for sort_by_pen_id_and_simulation_day() in manure_manager_output_handler.py."""
    # Arrange
    mocker.patch(
            'RUFAS.routines.manure.output_handler.manure_manager_output_handler.'
            'ManureManagerOutputHandler.__init__',
    ...
    patch_for_sort_by = mocker.patch(
            'RUFAS.routines.manure.output_handler.manure_manager_output_handler.'
            'ManureManagerOutputHandler.sort_by',
            return_value=None
    )

    patch_for_move_columns_to_front = mocker.patch(
            'RUFAS.routines.manure.output_handler.manure_manager_output_handler.'
            'ManureManagerOutputHandler.move_columns_to_front',
            return_value=None
    )

    # Act
    manure_manager_output_handler.sort_by_pen_id_and_simulation_day()
...
def test_export_to_csv(instance_df_exists: bool,
                       mocker: MockFixture) -> None:
    """Unit test for export_to_csv() in manure_manager_output_handler.py."""
    # Arrange
    mocker.patch(
            'RUFAS.routines.manure.output_handler.manure_manager_output_handler.'
            'ManureManagerOutputHandler.__init__',
    ...
    patch_for_get_csv_output_path = mocker.patch(
            'RUFAS.routines.manure.output_handler.manure_manager_output_handler.'
            'ManureManagerOutputHandler.get_csv_output_file_path',
            return_value=mock_csv_output_path
    )

    # Act
    actual_csv_output_path = manure_manager_output_handler.export_to_csv()
...
def test_get_main_output_directory(mocker: MockFixture) -> None:
    """Unit test for get_main_output_directory_path() in manure_manager_output_handler.py."""
    # Arrange
    ...
    # Act
    actual_main_output_directory = ManureManagerOutputHandler.get_main_output_directory_path()
...
def test_get_csv_output_directory(mocker: MockFixture) -> None:
    """Unit test for get_csv_output_directory_path() in manure_manager_output_handler.py."""
    # Arrange
    mock_main_output_directory_path = Path('test_main_output_directory')
    patch_for_get_main_output_directory = mocker.patch(
            'RUFAS.routines.manure.output_handler.manure_manager_output_handler.'
            'ManureManagerOutputHandler.get_main_output_directory_path',
            return_value=mock_main_output_directory_path
    )
    ...
    # Act
    actual_csv_dir_path = manure_manager_output_handler.get_csv_output_directory_path()
...
def test_get_csv_output_path(mocker: MockFixture) -> None:
    """Unit test for _get_csv_output_path() in manure_manager_output_handler.py."""
    # Arrange
    mock_csv_output_directory_path = Path('test_csv_output_directory')
    patch_for_get_csv_output_directory_path = mocker.patch(
            'RUFAS.routines.manure.output_handler.manure_manager_output_handler.'
            'ManureManagerOutputHandler.get_csv_output_directory_path',
    ...
    file_name = f'manure_manager_output_{mock_formatted_current_datetime}.csv'
    ...
    # Act
    actual_csv_output_path = manure_manager_output_handler.get_csv_output_file_path()
...
def test_empty_main_output_directory(mocker: MockFixture) -> None:
    """Unit test for empty_main_output_directory() in manure_manager_output_handler.py."""
    # Arrange
    ...
    path_for_delete_files_and_subdirectories = mocker.patch(
            'RUFAS.routines.manure.output_handler.manure_manager_output_handler.'
            'ManureManagerOutputHandler._delete_files_and_subdirectories',
            return_value=None
    )
    mocker.patch(
            'RUFAS.routines.manure.output_handler.manure_manager_output_handler.'
    ...
    # Act
    manure_manager_output_handler.empty_main_output_directory()
...
def test_delete_files_and_subdirectories(path_exists: bool,
    ...
    """Unit test for _delete_files_and_subdirectories() in manure_manager_output_handler.py."""
    # Arrange
    ...
    # Act
    ManureManagerOutputHandler._delete_files_and_subdirectories(mock_path)
