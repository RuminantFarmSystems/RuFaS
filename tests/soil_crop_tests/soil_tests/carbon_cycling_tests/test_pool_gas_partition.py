...
def test_soil_structural_slow_carbon_loss(soil_structural_slow_carbon_usage: float) -> None:
...
def test_soil_structural_active_carbon_remaining(soil_structural_active_carbon_usage: float) -> None:
...
def test_soil_structural_active_carbon_loss(soil_structural_active_carbon_usage: float) -> None:
...
def test_soil_metabolic_active_carbon_remaining(soil_metabolic_active_carbon_usage: float) -> None:
...
def test_soil_metabolic_active_carbon_loss(soil_metabolic_active_carbon_usage: float) -> None:
...
def test_plant_structural_slow_carbon_remaining(plant_structural_slow_carbon_usage: float) -> None:
...
def test_plant_structural_slow_carbon_loss(plant_structural_slow_carbon_usage: float) -> None:
...
def test_plant_structural_active_carbon_remaining(plant_structural_active_carbon_usage: float) -> None:
...
def test_plant_structural_active_carbon_loss(plant_structural_active_carbon_usage: float) -> None:
...
def test_plant_metabolic_active_carbon_remaining(plant_metabolic_active_carbon_usage: float) -> None:
...
def test_plant_metabolic_active_carbon_loss(plant_metabolic_active_carbon_usage: float) -> None:
...
def test_active_carbon_decomposition_amount(moisture_effect: float, temperature_effect: float,
...
def test_slow_carbon_decomposition_amount(decomposition_moisture_effect: float, decomposition_temperature_effect: float,
                                          slow_carbon_amount: float) -> None:
...
def test_passive_carbon_decomposition_amount(decomposition_moisture_effect: float,
...
def test_active_carbon_to_slow_amount(active_carbon_decomposition_amount: float,
                                      carbon_lost_adjusted_factor: float) -> None:
    ...
    assert expected == PoolGasPartition._determine_active_carbon_to_slow_amount(active_carbon_decomposition_amount,
...
def test_active_carbon_to_slow_loss(active_carbon_decomposition_amount: float,
                                    carbon_lost_adjusted_factor: float) -> None:
    ...
    assert expected == PoolGasPartition._determine_active_carbon_to_slow_loss(active_carbon_decomposition_amount,
                                                                              carbon_lost_adjusted_factor)
...
def test_active_carbon_to_passive_amount(active_carbon_decomposition_amount: float) -> None:
...
def test_passive_to_active_carbon_amount(passive_carbon_decomposition_amount: float) -> None:
...
def test_plant_active_decompose_carbon(plant_metabolic_active_carbon_remaining: float,
...
def test_soil_active_decompose_carbon(soil_metabolic_active_carbon_remaining: float,
                                      soil_structural_active_carbon_remaining: float) -> None:
    ...
    assert expected == PoolGasPartition._determine_soil_active_decompose_carbon(soil_metabolic_active_carbon_remaining,
...
def test_soil_active_carbon_amount(active_carbon_amount: float, plant_active_decompose_carbon: float,
...
def test_soil_slow_carbon_amount(slow_carbon_amount: float, plant_structural_slow_carbon_remaining: float,
...
def test_soil_passive_carbon_amount(passive_carbon_amount: float, slow_to_passive_carbon_amount: float,
