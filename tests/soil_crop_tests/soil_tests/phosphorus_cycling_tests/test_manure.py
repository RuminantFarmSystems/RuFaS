...
def test_determine_water_extractable_inorganic_phosphorus_leached(
...
def test_determine_water_extractable_organic_phosphorus_leached(
    manure: float, rain_manure_ratio: float, is_cow: bool
) -> None:
...
def test_determine_water_extractable_phosphorus_runoff_concentration(
    ...
    """
    observe = Manure._determine_water_extractable_phosphorus_runoff_concentration(
        manure, rain, field_size, distribution_factor
    )
...
def test_add_infiltrated_phosphorus_to_soil(amount_phosphorus: float, field_size: float) -> None:
    ...
    ) as mocked_add_to_labile_phosphorus:
...
def test_leach_and_update_phosphorus_pools(rain: float, runoff: float, area: float) -> None:
    ...
    incorp._determine_phosphorus_leached_from_surface = MagicMock(
        return_value={
...
@pytest.mark.parametrize(
    "temp_factor,machine_mass,machine_coverage,grazing_mass,grazing_field",
    [
...
def test_determine_assimilated_surface_manure(temp_factor: float, area: float) -> None:
    ...
    expected2 = {
        ...
        "machine_manure_coverage": expected_machine_coverage2,
        "assimilated_grazing_manure": 25,
        "grazing_manure_coverage": expected_grazing_coverage2,
    }
    expected_assimilation_calls2 = [
        call(0.77, temp_factor, expected_machine_cover_area2, False),
    ...
    expected3 = {
        "assimilated_machine_manure": 75,
        "machine_manure_coverage": expected_machine_coverage3,
        "assimilated_grazing_manure": 95,
        "grazing_manure_coverage": expected_grazing_coverage3,
    }
    expected_assimilation_calls3 = [
        call(0.80, temp_factor, expected_machine_cover_area3, False),
...
def test_daily_manure_update(rain: float, runoff: float, area: float, mean_temp: float) -> None:
    ...
    incorp1._determine_decomposed_surface_manure = MagicMock(
        return_value={
    ...
    incorp2._determine_decomposed_surface_manure = MagicMock(
        return_value={
    ...
    incorp3._determine_decomposed_surface_manure = MagicMock(
        return_value={
