...
@pytest.mark.parametrize("planting_event1,planting_event2,expected", [
    (PlantingEvent(crop_reference="corn", year=1, day=20, heat_scheduled_harvest=True),
     PlantingEvent(crop_reference="corn", year=1, day=20, heat_scheduled_harvest=True), True),
    (PlantingEvent(crop_reference="corn", year=3, day=20, heat_scheduled_harvest=True),
     PlantingEvent(crop_reference="corn", year=1, day=21, heat_scheduled_harvest=True), False),
    (PlantingEvent(crop_reference="corn", year=1, day=20, heat_scheduled_harvest=True),
     PlantingEvent(crop_reference="corn", year=1, day=20, heat_scheduled_harvest=False), False),
    (PlantingEvent(crop_reference="njnj", year=1, day=20, heat_scheduled_harvest=True),
     PlantingEvent(crop_reference="corn", year=1, day=20, heat_scheduled_harvest=True), False),
    (2, PlantingEvent(crop_reference="corn", year=1, day=20, heat_scheduled_harvest=True), False),
])
...
@pytest.mark.parametrize("planting_event,expected", [
    (PlantingEvent(crop_reference="corn", year=1, day=20, heat_scheduled_harvest=True), hash(("corn", 1, 20, True)))
])
...
@pytest.mark.parametrize("harvest_event1,harvest_event2,expected", [
    (HarvestEvent(crop_reference="corn", year=1, day=20),
     HarvestEvent(crop_reference="corn", year=1, day=20), True),
    (HarvestEvent(crop_reference="corn", year=3, day=20),
     HarvestEvent(crop_reference="corn", year=1, day=21), False),
    (HarvestEvent(crop_reference="corn", year=1, day=20),
     HarvestEvent(crop_reference="corn", year=1, day=20, operation="RUFAS"), False),
    (HarvestEvent(crop_reference="popcorn", year=1, day=20),
     HarvestEvent(crop_reference="corn", year=1, day=20), False),
...
@pytest.mark.parametrize("tillage_event1,tillage_event2,expected", [
    (TillageEvent(tillage_depth=9.24, incorporation_fraction=0.77, mixing_fraction=0.131),
     TillageEvent(tillage_depth=9.24, incorporation_fraction=0.77, mixing_fraction=0.131), True),
    (TillageEvent(tillage_depth=10.24, incorporation_fraction=0.77, mixing_fraction=0.131),
     TillageEvent(tillage_depth=9.24, incorporation_fraction=0.77, mixing_fraction=0.131), False),
    (TillageEvent(tillage_depth=9.24, incorporation_fraction=0.87, mixing_fraction=0.131),
     TillageEvent(tillage_depth=9.24, incorporation_fraction=0.77, mixing_fraction=0.131), False),
    (TillageEvent(tillage_depth=9.24, incorporation_fraction=0.87, mixing_fraction=0.131),
     TillageEvent(tillage_depth=9.24, incorporation_fraction=0.77, mixing_fraction=0.214), False),
    (2, TillageEvent(tillage_depth=9.24, incorporation_fraction=0.77, mixing_fraction=0.131), False),
])
...
@pytest.mark.parametrize("tillage_event,expected", [
    (TillageEvent(tillage_depth=9.24, incorporation_fraction=0.77, mixing_fraction=0.131),
...
@pytest.mark.parametrize("fertilizer_event1,fertilizer_event2,expected", [
    (FertilizerEvent(mix_name="20-10-10", year=1, day=27, nitrogen_mass=7.7, phosphorus_mass=9.24, depth=1.30,
                     surface_remainder_fraction=1.20),
     FertilizerEvent(mix_name="20-10-10", year=1, day=27, nitrogen_mass=7.7, phosphorus_mass=9.24, depth=1.30,
                     surface_remainder_fraction=1.20), True),
    (FertilizerEvent(mix_name="20-10-10", year=1, day=27, nitrogen_mass=7.7, phosphorus_mass=9.24, depth=1.30,
                     surface_remainder_fraction=1.20),
     FertilizerEvent(mix_name="20-10-30", year=1, day=27, nitrogen_mass=7.7, phosphorus_mass=9.24, depth=1.30,
                     surface_remainder_fraction=1.20), False),
    (FertilizerEvent(mix_name="20-10-10", year=1, day=27, nitrogen_mass=7.7, phosphorus_mass=9.24, depth=1.30,
                     surface_remainder_fraction=1.20),
     FertilizerEvent(mix_name="20-10-10", year=1, day=27, nitrogen_mass=7.6, phosphorus_mass=9.24, depth=1.30,
                     surface_remainder_fraction=1.20), False),
    (FertilizerEvent(mix_name="20-10-10", year=1, day=27, nitrogen_mass=7.7, phosphorus_mass=9.25, depth=1.30,
                     surface_remainder_fraction=1.20),
     FertilizerEvent(mix_name="20-10-10", year=1, day=27, nitrogen_mass=7.7, phosphorus_mass=9.24, depth=1.30,
                     surface_remainder_fraction=1.20), False),
    (FertilizerEvent(mix_name="20-10-10", year=1, day=27, nitrogen_mass=7.7, phosphorus_mass=9.24, depth=1.29,
                     surface_remainder_fraction=1.20),
     FertilizerEvent(mix_name="20-10-10", year=1, day=27, nitrogen_mass=7.7, phosphorus_mass=9.24, depth=1.30,
                     surface_remainder_fraction=1.20), False),
    (FertilizerEvent(mix_name="20-10-10", year=1, day=27, nitrogen_mass=7.7, phosphorus_mass=9.24, depth=1.30,
     ...
     FertilizerEvent(mix_name="20-10-10", year=1, day=27, nitrogen_mass=7.7, phosphorus_mass=9.24, depth=1.30,
                     surface_remainder_fraction=1.20), False),
    (2, FertilizerEvent(mix_name="20-10-10", year=1, day=27, nitrogen_mass=7.7, phosphorus_mass=9.24, depth=1.30,
                        surface_remainder_fraction=1.20), False),
])
...
@pytest.mark.parametrize("fertilizer_event,expected", [
    (FertilizerEvent(mix_name="20-10-10", year=1, day=27, nitrogen_mass=7.7, phosphorus_mass=9.24, depth=1.30,
                     surface_remainder_fraction=1.20),
     hash((1, 27, "20-10-10", 7.7, 9.24, 1.30, 1.20)))
])
