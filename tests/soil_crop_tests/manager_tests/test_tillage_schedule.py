...
@pytest.mark.parametrize(
    "name,years,days,depths,incorp_fracs,mix_fracs,expected",
    [
        (
            "test_1",
            [1990, 1989, 1991],
...
@pytest.mark.parametrize(
    "depths,incorp_fracs,mix_fracs,expected_depths,expected_incorp,expected_mix",
    [
...
@pytest.mark.parametrize(
    "depths,incorp_fracs,mix_fracs,years,days,skip,repeat,expected",
    [
        (
            [200, 200, 300],
            [0.5],
            ...
            1,
            [
                TillageEvent(200, 0.5, 0.45, 1990, 90),
                TillageEvent(200, 0.5, 0.45, 1990, 120),
                TillageEvent(300, 0.5, 0.47, 1990, 200),
                TillageEvent(200, 0.5, 0.45, 1991, 90),
                TillageEvent(200, 0.5, 0.45, 1991, 120),
                TillageEvent(300, 0.5, 0.47, 1991, 200),
            ],
        ),
        (
            [150],
            ...
            2,
            [
                TillageEvent(150, 0.3, 0.6, 1993, 100),
        ...
        (
            ...
            2,
            [
                TillageEvent(150, 0.4, 0.2, 1991, 120),
