...
@pytest.mark.parametrize("crop_schedule_config,expected", [
    ...
    ([
         {"crop_species": "corn", "planting_years": [2010], "pattern_repeat": 0, "planting_skip": 1,
          "harvesting_skip": 1, "planting_days": [121], "harvest_years": [2010], "harvest_days": [319],
          "harvest_operations": ["harvest_kill"], "harvest_type": "optimal", "planting_order": "1st",
          "extracted": True},
         {"crop_species": "corn", "planting_years": [2011], "pattern_repeat": 0, "planting_skip": 3,
          "harvesting_skip": 1, "planting_days": [121], "harvest_years": [2011], "harvest_days": [319],
          "harvest_operations": ["harvest_kill"], "harvest_type": "scheduled", "planting_order": "1st",
          "extracted": True},
         {"crop_species": "corn", "planting_years": [2012], "pattern_repeat": 0, "planting_skip": 1,
          "harvesting_skip": 2, "planting_days": [121], "harvest_years": [2012], "harvest_days": [319],
          "harvest_operations": ["harvest_kill"], "harvest_type": "optimal", "planting_order": "1st",
          "extracted": True},
         {"crop_species": "corn", "planting_years": [2013], "pattern_repeat": 0, "planting_skip": 1,
          "harvesting_skip": 1, "planting_days": [121], "harvest_years": [2013], "harvest_days": [319],
          "harvest_operations": ["harvest_kill"], "harvest_type": "scheduled", "planting_order": "1st",
          "extracted": True}
