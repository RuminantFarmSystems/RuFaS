...
@pytest.mark.parametrize("manure_schedule_data,expected_manure_schedule", [
    ({
         ...
         "pattern_skip": 0
                       ...
                       nitrogen_masses=[266, 266, 201, 207, 230, 279, 214, 244, 320, 169, 355, 163, 245, 66, 275],
                       phosphorus_masses=[70, 70, 45, 36, 37, 50, 31, 48, 53, 20, 60, 29, 43, 30, 54],
                       manure_types=[ManureType.LIQUID, ManureType.LIQUID, ManureType.LIQUID, ManureType.LIQUID, ManureType.LIQUID, ManureType.LIQUID,
                                     ManureType.LIQUID, ManureType.LIQUID, ManureType.LIQUID, ManureType.LIQUID, ManureType.LIQUID, ManureType.LIQUID,
