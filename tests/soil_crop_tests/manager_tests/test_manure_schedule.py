...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            1,
            [
                ManureEvent(20, 20, ManureType.LIQUID, 0.8, 0, 1.0, 1990, 100),
                ManureEvent(20, 25, ManureType.LIQUID, 0.8, 0, 1.0, 1992, 100),
                ManureEvent(20, 20, ManureType.LIQUID, 0.8, 0, 1.0, 1994, 100),
                ManureEvent(20, 25, ManureType.LIQUID, 0.8, 0, 1.0, 1996, 100),
            ],
        ),
        (
            [1990, 1990],
            ...
            2,
            [
                ManureEvent(25, 5, ManureType.LIQUID, 0.8, 15, 0.3, 1990, 100),
                ManureEvent(10, 5, ManureType.LIQUID, 0.6, 0, 1.0, 1990, 200),
                ManureEvent(25, 5, ManureType.LIQUID, 0.8, 15, 0.3, 1991, 100),
                ManureEvent(10, 5, ManureType.LIQUID, 0.6, 0, 1.0, 1991, 200),
                ManureEvent(25, 5, ManureType.LIQUID, 0.8, 15, 0.3, 1992, 100),
                ManureEvent(10, 5, ManureType.LIQUID, 0.6, 0, 1.0, 1992, 200),
            ],
        ),
        (
            [1998],
            ...
            6,
            [
                ManureEvent(27, 22, ManureType.LIQUID, 0.85, 0, 1.0, 1998, 115),
                ManureEvent(27, 22, ManureType.LIQUID, 0.85, 0, 1.0, 1999, 115),
                ManureEvent(27, 22, ManureType.LIQUID, 0.85, 0, 1.0, 2000, 115),
                ManureEvent(27, 22, ManureType.LIQUID, 0.85, 0, 1.0, 2001, 115),
                ManureEvent(27, 22, ManureType.LIQUID, 0.85, 0, 1.0, 2002, 115),
                ManureEvent(27, 22, ManureType.LIQUID, 0.85, 0, 1.0, 2003, 115),
                ManureEvent(27, 22, ManureType.LIQUID, 0.85, 0, 1.0, 2004, 115),
            ],
        ),
        (
            ...
            0,
            [
                ManureEvent(18, 10, ManureType.LIQUID, 0.9, 30, 0.7, 1992, 95),
                ManureEvent(18, 10, ManureType.LIQUID, 0.9, 30, 0.7, 1993, 94),
                ManureEvent(18, 10, ManureType.LIQUID, 0.9, 30, 0.7, 1994, 100),
                ManureEvent(18, 10, ManureType.LIQUID, 0.9, 30, 0.7, 1995, 95),
                ManureEvent(18, 10, ManureType.LIQUID, 0.9, 30, 0.7, 1996, 96),
                ManureEvent(18, 10, ManureType.LIQUID, 0.9, 30, 0.7, 1997, 89),
                ManureEvent(18, 10, ManureType.LIQUID, 0.9, 30, 0.7, 1998, 90),
                ManureEvent(18, 10, ManureType.LIQUID, 0.9, 30, 0.7, 1999, 93),
            ],
        ),
    ],
)
