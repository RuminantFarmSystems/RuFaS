...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("verbose", True, True, False, True, True),
        ("block", True, True, True, False, True),
        ("inline", True, True, True, True, False),
        ("verbose", False, False, True, True, True),
        ("block", False, True, False, True, True),
        ("inline", False, True, True, False, True),
        ("verbose", False, True, True, True, False),
        ("block", False, False, False, True, True),
        ("inline", False, False, True, False, True),
