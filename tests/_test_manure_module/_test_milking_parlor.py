...
def test_total_minutes_spent_in_holding_area(
    mock_milking_parlor: MilkingParlor,
) -> None:
...
def test_calc_wash_water_volume_used_in_holding_area(
    mock_milking_parlor: MilkingParlor,
) -> None:
...
def test_total_minutes_spent_milking(mock_milking_parlor: MilkingParlor) -> None:
    ...
    # Arrange
    expected_total_minutes_spent_milking = (
        mock_milking_parlor.num_milkings * mock_milking_parlor.minutes_spent_per_milking
    )
...
def test_calc_total_water_volume_used_in_milking_parlor(
...
def test_calc_manure_volume_deposited_in_milking_parlor(
    mocker: MockerFixture, mock_milking_parlor: MilkingParlor
) -> None:
    ...
    expected_manure_volume_deposited_in_milking_parlor = (
        manure_mass_deposited_in_milking_parlor / ManureConstants.MANURE_DENSITY
    )
