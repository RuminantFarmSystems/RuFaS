...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("anaerobic digester", AnaerobicDigester),
        ("continuous_mix", AnaerobicDigester),
        ("parlor cleaning", ParlorCleaningHandler),
        ("single stream handler", SingleStreamHandler),
        ("alley-scraper", SingleStreamHandler),
        ("manual_scraper", SingleStreamHandler),
        ("flush system", SingleStreamHandler),
