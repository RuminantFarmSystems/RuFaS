...
def test_process_manure(
    ...
    mock_report_slurry_storage_outputs = mocker.patch.object(
        slurry_storage_underfloor, "_report_slurry_storage_underfloor_outputs", return_value=None)
