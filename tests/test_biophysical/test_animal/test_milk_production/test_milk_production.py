...
def test_calculate_305_day_milk_yield(l_param: float, m_param: float, n_param: float, expected: float) -> None:
    ...
    assert MilkProduction.calculate_mature_305_day_milk_prediction(l_param, m_param, n_param, None) == pytest.approx(
        expected, rel=1e-6
    )
...
def test_calculate_305_day_milk_yield_uses_available_history() -> None:
    ...
    result = MilkProduction.calculate_mature_305_day_milk_prediction(
