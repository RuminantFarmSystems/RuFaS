...
def test_process_degradations(
    ...
    mock_reset_mass = mocker.patch.object(sileage, "reset_mass_attributes_after_loss")
    ...
    expected_reset_mass_calls = [mocker.call(mock_first_crop, loss), mocker.call(mock_second_crop, loss)]
