...
- [3209](https://github.com/RuminantFarmSystems/RuFaS/pull/3209) - [minor change] [E2ETesting] [NoInputChange] [NoOutputChange] Adds ability to average multiple e2e testing runs across different random seeds.
...
- [3275](https://github.com/RuminantFarmSystems/RuFaS/pull/3275) - [minor change] [E2E Testing] [NoInputChange] [NoOutputChange] Removes `deepdiff` check from the process to update e2e expected results.
