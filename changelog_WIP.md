...
- [2972](https://github.com/RuminantFarmSystems/RuFaS/pull/2972) - [minor change] [OutputManager] [NoInputChange] [NoOutputChange] Adds an `is_daily_variable` flag to reported variables so OutputManager can identify variables not reported daily.
