...
- [3136](https://github.com/RuminantFarmSystems/RuFaS/pull/3136) - [minor change] [Testing] [EEE] [InputChange] [NoOutputChange] Adds `animals_only` end-to-end testing and fixes `EmissionsEstimator` crash when feed storage inputs are excluded.
