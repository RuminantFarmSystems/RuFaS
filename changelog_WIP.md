...
- [XXXX](https://github.com/RuminantFarmSystems/RuFaS/pull/XXXX) - [minor change] [EEE] [NoInputChange] [NoOutputChange] Extracts repetitive logic from the farmgrown feed emissions calculation and reporting functions.
