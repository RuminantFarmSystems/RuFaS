...
- [3138](https://github.com/RuminantFarmSystems/RuFaS/pull/3138) - [minor change] [Properties] [InputChange] [NoOutputChange] Moves properties files to within the `RUFAS/` directory.
