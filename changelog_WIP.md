...
- [3235](https://github.com/RuminantFarmSystems/RuFaS/pull/3235) - [minor change] [Dependabot] [NoInputChange] [NoOutputChange] Updates file-target of dependabot-change PRs for tagging dev-team members for review.- [3248](https://github.com/RuminantFarmSystems/RuFaS/pull/3248) - [minor change] [Animal] [InputChange] [OutputChange] Adds `set_DMI` and `set_DMI_per_X` intake options so users can control dry matter intake of user-defined rations directly or per unit of milk yield / average daily gain, with cross-validation rules for the new `intake_option`/`intake_value` ration inputs.
- [2043](https://github.com/RuminantFarmSystems/RuFaS/pull/2043) - [major change] [Animal] [NoInputChange] [NoOutputChange] Improves calf ration formulation. Uses requirement calculations to determine intake and proportion of feed ingredients.
