...
- [2972](https://github.com/RuminantFarmSystems/RuFaS/pull/2972) - [minor change] [OutputManager] [NoInputChange] [OutputChange] Adds an `is_daily_variable` flag to reported variables and two diagnostic CSVs listing variables reported daily vs. not.
