...
- [3273](https://github.com/RuminantFarmSystems/RuFaS/pull/3273) - [minor change] [E2E Testing] [NoInputChange] [NoOutputChange] Validates the end-to-end comparison configuration (expected results, must-change, and conversion files) before the simulation runs, so configuration mistakes fail in seconds instead of after the full run.
