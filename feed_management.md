...
Forage quality of “purchased” feeds is a database entry queried in the `Feed` class.
...
5. Quality assessment for farm grown feeds to be based on the fr_PHU (fraction of potential heat units) 
