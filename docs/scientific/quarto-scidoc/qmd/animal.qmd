...
**Total Protein** <br>
Reporting of protein requirements is divided into four components: maintenance, growth, pregnancy, and lactation (all in metabolizable protein). For details about the variables included in each calculation, please refer to the protein requirements key.
...
$$
\text{MPlact} = \text{Milk} \times \frac{\text{TP}_{\text{Milk}}}{100} \times \frac{1000}{0.67}
$$
:::
