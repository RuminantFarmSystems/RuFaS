...
$$
\text{NPAAMFP} = \text{NPMFP} \times \frac{\text{AACorrMFP}}{100}
$$
:::
...
$$
\begin{aligned}
\text{RecomMPSupply1} &= \frac{\text{NetAAScurf} + \text{NetAAMFP} + \text{NetAAMilk} + \text{NetAAGrowth}}{\text{TargetEffMP}} \\[8pt]
...
$$
\begin{aligned}
\text{RecomMPAASupply1} &= \frac{\text{NPScurf} + \text{NPMFP} + \text{NPMilk} + \text{NPGrowth}}{\text{TargetEffAA}} \\[8pt]
...
$$
\text{RecomMPSupply2} = \frac{text{NPScurf} + \text{NPMFP}}{\text{TargetEffMP}} + \frac{\text{NPGest}}{0.33} + \frac{\text{NPGrowth}}{0.4} + \text{NPEndUrin}
$$
:::
...
$$
\begin{aligned}
\text{RecomMPAASupply2} &= \frac{\text{NetAAScurf} + \text{NetAAMFP}}{\text{NetAAMFP}} + \frac{\text{NetAAGest}}{0.33} + \frac{\text{NetAAGrowth}}{0.4} \\[8pt]
& \qquad + \text{NPEndUrin}
\end{aligned}
$$
:::
...
$$
\text{P}_{\text{growth}} = 1.2 + (4.635 \times \text{MW}^{0.22} \times \text{BW}^{-0.22}) + \text{ADG}
$$
:::
...
The denominator, 715 kg, is the average cow weight in the study by @house1993; therefore, the pregnancy (gestation) requirement is scaled to that BW. For details see Page 107 in the Minerals chapter of [@nrc_2021]. IF DOP $<$ 190; then it is assumed that `Ca_Preg` is equal to zero.
...
$$
\text{Ca}_{\text{lact}} = (0.295 + 0.239 \times \text{MilkTP}) \times \text{Milk}
$$
:::
...
$$
\text{P}_{\text{lact}} = \text{Milk} \times (0.496 + 0.13 \times \text{TPMilk}); \text{Milk} \times 0.90
$$
:::
