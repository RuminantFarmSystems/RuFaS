...
tbl = pd.read_csv(
  "../resources/table_data/animal_tables/animal-growth_required-inputs.csv",
  dtype = {"Default": str, "Min": str, "Max": str},
  keep_default_na = False
).to_markdown(
  index = False,
  maxcolwidths = [None, 32, 10, 4, 4],
  tablefmt = "colon_grid",
...
Note - truncated at 2 standard deviations in [AN.BWT.6](#eq-one)

#### Calf Growth 

Calves are assumed to double their weight between birth and weaning based on recommendations 
in the @nrc2001. Thus the target average daily gain is estimated as:
...
$$     
\text{bodyweight\_tissue\_change} = \frac{P_1}{P_2} \times exp\bigg(1 - \frac{\text{DIM}}{P_2}\bigg) + \
  \text{DIM} \times exp\bigg(1 - \frac{\text{DIM}}{P_2}\bigg)
$$
...
$$
\text{tissue\_changed} = P_1 \times \frac{\text{DIMlast}}{P_2} \times exp \bigg(1 - \frac{\text{DIMlast}}{P_2}\bigg) + \
  \text{DIM} \times exp \bigg(1 - \frac{\text{DIM}}{P_2}\bigg)
$$
...
Because the equations that predict total manure excreted and total solids excreted rely on different inputs, in some extreme cases, the total mass of manure excreted can be predicted to be very close to the predicted total solids excreted which is unrealistically dry. For this reason, we set a maximum manure dry matter content of 20\% for heifers and dry cows. If the mass predicted by equation [AN.EXC.11](#eq-an-ex-11) is not greater than (total solids/minimum dry matter) then, 

::: {#eq-an-exc-11ALT}
$$
\text{total\_manure\_excreted} = \frac{\text{total\_solids}}{\text{dry\_matter\_manure}} \qquad \text{[AN.EXC.11ALT]}
$$ 
:::
...
::: {#eq-an-exc-12}
$$
\text{total\_solids} = 0.178 \times \text{dry\_matter\_intake} + 2.733 \qquad \text{[AN.EXC.12]}
$$
:::
...
::: {#eq-an-exc-13}
$$
\text{total\_volatile\_solids} = 0.0071 \times \text{body\_weight} \qquad \text{[AN.EXC.13]}
$$
:::
...
::: {#eq-an-exc-14}
$$
\text{manure\_nitrogen} = 15.1 + 8.83 \times \frac{\left(\text{dry\_matter\_intake} \times 1000 \times \frac{\frac{\text{crude\_protein\_concentration}}{6.25}}{100}\right)}{1000} \qquad \text{[AN.EXC.14]}
$$
:::
...
::: {#eq-an-exc-15}
$$
\text{fecal\_nitrogen} = 0.345 + 0.317 \times \frac{\left(\text{dry\_matter\_intake} \times 1000 \times \frac{\frac{\text{crude\_protein\_concentration}}{6.25}}{100}\right)}{1000} \qquad \text{[AN.EXC.15]}
$$
:::
...
::: {#eq-an-exc-16}
$$
\text{urine}_{\text{nitrogen}} = \text{manure}_{\text{nitrogen}} - \text{fecal}_{\text{nitrogen}} \qquad \text{[AN.EXC.16]}
$$
:::
...
::: {#eq-an-exc-9}
$$
\text{manure\_total\_ammoniacal\_nitrogen} = \text{urine\_nitrogen} \qquad \text{[AN.EXC.9]}
$$
:::
...
::: {#eq-an-exc-17}
$$
\text{potassium} = 1000 \times \text{dry\_matter\_intake} \times \frac{\text{potassium\_concentration}}{100} \qquad \text{[AN.EXC.17]}
$$
:::
...
::: {#eq-an-exc-18}
$$
\text{fecal\_water} = \left(1.987 \times \text{dry\_matter\_intake}\right) + \left(0.348 \times \text{acid\_detergent\_fiber\_concentrations}\right) - \left(0.412 \times \text{crude\_protein\_concentration}\right) - \left(0.074 \times \text{dry\_matter\_concentration}\right) - \left(0.0057 \times \text{days\_in\_milk}\right) \qquad \text{[AN.EXC.18]}
$$
::: 
...
::: {#eq-an-exc-19}
$$
\text{fecal\_solids} = 0.576 + \left(0.370 \times \text{dry\_matter\_intake}\right) - \left(0.075 \times \text{crude\_protein\_concentration}\right)+ \left(0.059 \times \text{acid\_detergent\_fiber\_concentrations}\right) \qquad \text{[AN.EXC.19]}
$$ 
:::
...
::: {#eq-an-exc-20}
$$
\text{urine} = -7.742 + \left(0.388 \times \text{dry\_matter\_intake}\right) + \left(0.726 \times \text{crude\_protein\_concentration}\right) + \left(2.066 + \text{milk\_protein}\right) \qquad \text{[AN.EXC.20]}
$$ 
:::
...
::: {#eq-an-exc-21}
$$
\text{total\_manure\_excreted} = \text{fecal\_water} + \text{fecal\_solids} + \text{urine} \qquad \text{[AN.EXC.21]}
$$
:::
...
::: {#eq-an-exc-22}
$$
\text{organic\_matter\_intake} = \text{dry\_matter\_intake} - \text{ash\_diet\_content} \qquad \text{[AN.EXC.22]}
$$
:::
...
::: {#eq-an-exc-23}
$$
\text{degradable\_volatile\_solids} = -1.017 + \left(0.364 \times \text{organic\_matter\_intake}\right) + \left(0.029 \times \text{neutral\_detergent\_fiber\_concentration}\right) - \left(0.023 \times \text{crude\_protein\_concentration}\right) \qquad \text{[AN.EXC.23]}
$$ 
:::
...
::: {#eq-an-exc-24}
$$
\text{total\_volatile\_solids} = -1.201 + \left(0.402 \times \text{organic\_matter\_intake}\right) + \left(0.036 \times \text{neutral\_detergent\_fiber\_concentration}\right) - \left(0.024 \times \text{crude\_protein\_concentration}\right) \qquad \text{[AN.EXC.24]}
$$ 
:::
...
::: {#eq-an-exc-25}
$$
\text{manure\_nitrogen} = 20.3 + 0.654 \times \frac{\left(\text{dry\_matter\_intake} \times 1000 \times \frac{\frac{\text{crude\_protein\_concentration}}{6.25}}{100}\right)}{1000} \qquad \text{[AN.EXC.25]}
$$
:::
...
::: {#eq-an-exc-26}
$$
\text{fecal\_nitrogen} = \frac{\left(10.1 \times \text{dry\_matter\_intake} - 18.5 \right)}{1000} \qquad \text{[AN.EXC.26]}
$$
:::
...
::: {#eq-an-exc-27}
$$
\text{potassium} = \left(7.21 \times \text{dry\_matter\_intake}\right) + \left(15944 \times \frac{\text{potassium\_concentration}}{100}\right) - 164.5 \qquad \text{[AN.EXC.27]}
$$ 
:::
...
::: {#eq-an-exc-28}
$$
\text{urine} = 15.4 \qquad \text{[AN.EXC.28]}
$$
:::
...
::: {#eq-an-exc-29}
$$
\text{total\_manure\_excreted} = \left(0.00711 \times \text{body\_weight}\right) + \left(0.324 \times \text{crude\_protein\_concentration}\right) + \left(0.259 \times \text{neutral\_detergent\_fiber\_concentration}\right) \qquad \text{[AN.EXC.29]}
$$
:::

Because the equations that predict total manure excreted and total solids excreted rely on different inputs, in some extreme cases, the total mass of manure excreted can be predicted to be very close to the predicted total solids excreted which is unrealistically dry. For this reason, we set a maximum manure dry content of 20% for heifers and dry cows. If the mass predicted by equation [AN.EXC.11](#eq-an-ex-11) is not great than (total solids/maximum manure dry matter content) then,
...
::: {#eq-an-exc-30}
$$
\text{manure\_phosphorus\_fraction} = \frac{\text{fecal\_phosphorus} + \text{urine\_phosphorus\_required}}{\text{total\_manure\_excreted} \times 1000 g/kg} \qquad \text{[AN.EXC.30]}
$$
:::
...
::: {#eq-an-exc-31}
$$
\text{inorganic\_phosphorus\_fraction} = 0.50 \times \text{manure\_phosphorus\_fraction} \qquad \text{[AN.EXC.31]}
$$ 
:::
...
::: {#eq-an-exc-32}
$$
\text{organic\_phosphorus\_fraction} = 0.05 \times \text{manure\_phosphorus\_fraction} \qquad \text{[AN.EXC.32]}
$$ 
:::
...
::: {#eq-an-exc-33}
$$
\text{phosphorus\_in\_milk} = 0.0009 \times \text{daily\_milk\_production} \times 1000 g/kg \qquad \text{[AN.EXC.33]}
$$ 
:::
...
::: {#eq-an-exc-34}
$$
\text{manure\_phosphorus\_excreted} = \text{fecal\_phosphorus} + \text{urine\_phosphorus\_required} \qquad \text{[AN.EXC.34]}
$$ 
:::
...
::: {#eq-an-exc-35}
$$
\text{total\_phosphorus\_excreted} = \text{phosphorus\_in\_milk} + \text{fecal\_phosphorus} + \text{urine\_phosphorus\_required} \qquad \text{[AN.EXC.35]}
$$ 
:::
