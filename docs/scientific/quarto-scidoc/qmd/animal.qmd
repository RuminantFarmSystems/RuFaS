...
$$
<p style="text-align: right;">[AN.EXC.1]</p>
...
\text{urine} = 2.0
$$
<p style="text-align: right;">[AN.EXC.2]</p>
...
$$
<p style="text-align: right;">[AN.EXC.3]</p>
...
$$
<p style="text-align: right;">[AN.EXC.4]</p>
...
$$
<p style="text-align: right;">[AN.EXC.5]</p>
...
$$
<p style="text-align: right;">[AN.EXC.6]</p>
...
::: {#eq-an-exc-7}
$$
\text{manure\_nitrogen} = \frac{\left(112.55 \times \text{dry\_matter\_intake} \times \frac{\text{crude\_protein}}{100}\right)}{1000} 
$$
<p style="text-align: right;">[AN.EXC.7]</p>
...
$$
<p style="text-align: right;">[AN.EXC.8]</p>
...
$$
<p style="text-align: right;">[AN.EXC.9]</p>
...
\text{urine} = 9.0 
$$
<p style="text-align: right;">[AN.EXC.10]</p>
...
$$
<p style="text-align: right;">[AN.EXC.11]</p>
...
$$
<p style="text-align: right;">[AN.EXC.11ALT]</p>
...
$$
<p style="text-align: right;">[AN.EXC.12]</p>
...
$$
<p style="text-align: right;">[AN.EXC.13]</p>
...
::: {#eq-an-exc-14}
$$
\text{manure\_nitrogen} = 15.1 + 8.83 \times \frac{\left(\text{dry\_matter\_intake} \times 1000 \times \frac{\frac{\text{crude\_protein\_concentration}}{6.25}}{100}\right)}{1000}
$$
<p style="text-align: right;">[AN.EXC.14]</p>
...
::: {#eq-an-exc-15}
$$
\text{fecal\_nitrogen} = 0.345 + 0.317 \times \frac{\left(\text{dry\_matter\_intake} \times 1000 \times \frac{\frac{\text{crude\_protein\_concentration}}{6.25}}{100}\right)}{1000}
$$
<p style="text-align: right;">[AN.EXC.15]</p>
...
$$
<p style="text-align: right;">[AN.EXC.16]</p>
...
$$
<p style="text-align: right;">[AN.EXC.17]</p>
...
$$
<p style="text-align: right;">[AN.EXC.18]</p>
...
\end{aligned}
$$
<p style="text-align: right;">[AN.EXC.19]</p>
...
\end{aligned}
$$
<p style="text-align: right;">[AN.EXC.20]</p>
...
$$
<p style="text-align: right;">[AN.EXC.21]</p>
...
$$
<p style="text-align: right;">[AN.EXC.22]</p>
...
\end{aligned}
$$
<p style="text-align: right;">[AN.EXC.23]</p>
...
\end{aligned}
$$
<p style="text-align: right;">[AN.EXC.24]</p>
...
\text{non\_degradable\_volatile\_solids} = \text{total\_volatile\_solids} - \text{degradable\_volatile\_solids} 
$$
<p style="text-align: right;">see [[AN.EXC.6]](#eq-an-exc-6)</p>
...
$$
<p style="text-align: right;">[AN.EXC.25]</p>
...
$$
<p style="text-align: right;">[AN.EXC.26]</p>
...
\text{urine}_{\text{nitrogen}} = \text{manure}_{\text{nitrogen}} - \text{fecal}_{\text{nitrogen}}
$$
<p style="text-align: right;">see [[AN.EXC.16]](#eq-an-exc-16)</p>
...
<p style="text-align: right;">see [[AN.EXC.9]](#eq-an-exc-9)</p>
...
$$
<p style="text-align: right;">[AN.EXC.27]</p>
...
\text{urine} = 15.4
$$
<p style="text-align: right;">[AN.EXC.28]</p>
...
\end{aligned}
$$
<p style="text-align: right;">[AN.EXC.29]</p>
...
\text{total\_manure\_excreted} = \frac{\text{total\_solids}}{\text{dry\_matter\_manure}}
$$
<p style="text-align: right;">see [[AN.EXC.11ALT]](#eq-an-exc-11ALT)</p>
...
\text{total\_solids} = 0.178 \times \text{dry\_matter\_intake} + 2.733
$$
<p style="text-align: right;">see [[AN.EXC.12]](#eq-an-exc-12)</p>
...
\text{organic\_matter\_intake} = \text{dry\_matter\_intake} - \text{ash\_diet\_content}
$$
<p style="text-align: right;">see [[AN.EXC.22]](#eq-an-exc-22)</p>
...
\end{aligned}
$$
<p style="text-align: right;">see [[AN.EXC.23]](#eq-an-exc-23)</p>
...
\end{aligned}
$$
<p style="text-align: right;">see [[AN.EXC.24]](#eq-an-exc-24)</p>
...
$$
<p style="text-align: right;">[AN.EXC.30]</p>
...
$$
<p style="text-align: right;">[AN.EXC.31]</p>
...
$$
<p style="text-align: right;">[AN.EXC.32]</p>
...
$$
<p style="text-align: right;">[AN.EXC.33]</p>
...
$$
<p style="text-align: right;">[AN.EXC.34]</p>
...
::: {#eq-an-exc-35}
$$
\text{total\_phosphorus\_excreted} = \text{phosphorus\_in\_milk} + \text{fecal\_phosphorus} + \text{urine\_phosphorus\_required} 
$$
<p style="text-align: right;">[AN.EXC.35]</p>
...
\end{aligned}
$$
<p style="text-align: right;">[AN.MET.1]</p>
...
\end{aligned}
$$
<p style="text-align: right;">[AN.MET.2]</p>
...
::: {#eq-an-met-3}
$$
\text{starch\_acid\_detergent\_fiber\_concentration\_ratio} = -0.0011 \times \frac{\text{starch\_concentration}}{\text{acid\_detergent\_fiber\_concentrations}}
$$
<p style="text-align: right;">[AN.MET.3]</p>
...
$$
<p style="text-align: right;">[AN.MET.4]</p>
...
$$
<p style="text-align: right;">[AN.MET.5]</p>
...
\end{aligned}
$$
<p style="text-align: right;">[AN.MET.6]</p>
...
$$
\begin{aligned}
\text{methane\_emission}
&\quad =
\frac{
45.98
\times e^{- \left(
\text{starch\_to\_acid\_detergent\_fiber\_concentration\_ratio}
+ 0.0045
\right)}
\times \text{metabolizable\_energy\_intake}
\times 4.184
}{
0.05565
}
\end{aligned}
$$
<p style="text-align: right;">[AN.MET.7]</p>
...
\end{aligned}
$$
<p style="text-align: right;">see [[AN.EXC.7]](#eq-an-exc-7)</p>
...
\text{methane\_emission} = \frac{0.065 \times \text{gross\_energy\_concentrationdry\_matter\_intake}}{0.05565} 
$$
<p style="text-align: right;">see [[AN.EXC.5]](#eq-an-exc-5)</p>
...
This module predicts the daily enteric methane emissions for individual animals: Below is the [previous table from the Emissions section](#tbl-an-output-methane).
```{python}
...
\end{aligned}
$$
<p style="text-align: right;">[AN.MET.8]</p>
...
\end{aligned}
$$
<p style="text-align: right;">[AN.MET.9]</p>
...
$$
<p style="text-align: right;">[AN.MET.10]</p>
...
$$
\begin{aligned}
\text{adjusted\_methane\_emission}
&=
\text{methane\_yield}
\times
\left(
1 +
\frac{\text{methane\_yield\_reduction}}{100}
\right)
\times
\text{dry\_matter\_intake}
\end{aligned}
$$
<p style="text-align: right;">[AN.MET.11]</p>
:::
