...
**Pregnancy** <br>
Daily rates of wet tissue deposition (kg/d) are derived from equations [AN.NSM.2](#eq-an-nsm-2) and [AN.NSM.2](#eq-an-nsm-3) as defined above.
...
$$
\text{MilkEn} = (0.0929 \times \text{Fat\_Milk}) + (0.0547 \times \text{Prot\_Milk}) + (0.0395 \times \text{Lact\_Milk})
$$
:::
...
$$
\text{MilkEn} = (0.0929 \times \text{Fat\_Milk}) + (0.0585 \times \text{TP\_Milk}) + (0.0395 \times \text{Lact\_Milk})
$$
:::
