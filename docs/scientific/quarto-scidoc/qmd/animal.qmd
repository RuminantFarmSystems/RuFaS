...
\text{MEacti} =
\begin{cases}
(1.01 \times \text{DEact}_{i}) + (0.0046 \times 0.0046 \times \text{EE}_{i}) - 3,& \text{if feed type is not fat and fat content is} \geq3\% \\[8pt]
(1.01 \times \text{DEact}_{i}) - 0.45,& \text{if feed type is not fat and fat content is} \leq3\% \\[8pt]
(1.01 \times \text{DEact}_{i}),& \text{if feed type is fat}
\end{cases}
$$
:::
...
\text{NEmacti} =
\begin{cases}
(1.37 \times \text{MEact}_{i}) - (0.138 \times \text{MEact}_{i}^2) + (0.0105 \times \text{MEact}_{i}^3) - 1.12 ,& \text{if feed type is not fat} \\[8pt]
(0.8 \times \text{MEact}_{i}) ,& \text{if feed type is fat} 
\end{cases}
$$
:::
...
\text{NElacti}=
\begin{cases}
(0.703 \times \text{MEact}_{i}) - 0.019 + (0.097 \times \text{MEact}_{i}) + (0.1997 \times \text{EE}_{i}) - 3 ,& \text{if feed type is not fat and fat content is} \geq3\% \\[8pt]
(0.703 \times \text{MEact}_{i}) - 0.19 ,& \text{if feed type is not fat and fat content is} \leq3\% \\[8pt]
(0.8 \times \text{DEact}_{i}) ,& \text{if feed type is fat}
\end{cases}
$$
:::
...
=
\begin{cases}
(1.42 \times \text{MEact}_{i}) - (0.174 \times \text{MEact}_{i}^2) + (0.0122 \times \text{MEact}_{i}^3) - 1.65 ,& \text{if feed type is not fat} \\[8pt]
(0.55 \times \text{MEact}_{i}) ,& \text{if feed type is fat} 
\end{cases}
$$
:::
...
We use calcium as an example, but phosphorus calculations are analagous.
