...
* Death day probability: `death_day_prob`
   * Values to construct the CDF to determine future death day, given that death is going to occur (default values are given in @tbl-an-cull-cdf-death)
   * Values in the array correspond to the days in `cull_day_count` (another user input; default values are the “days” in @tbl-an-cull-cdf-death)
