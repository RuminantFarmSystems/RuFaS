...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{\# Module Name {-}{-}\textgreater{} section title and only appears once}

\FunctionTok{\#\# Module Introduciton {-}{-}\textgreater{} subsection header}

\FunctionTok{\#\# Each Section Title {-}{-}\textgreater{} subsection header that introduces distinct portions of each module that require separate methodological descriptions and equations}

\FunctionTok{\#\#\# Section Introduction {-}{-}\textgreater{} subsubsection header to introduce the concept}

\FunctionTok{\#\#\# Methodology {-}{-}\textgreater{} subsubsection header used to start descriptions}

\NormalTok{**Relevant Inputs or Relevant Outputs** {-}{-}\textgreater{} emphasized headers should be used to report the inputs and outputs of the relevant subsection. These usually include tables and bulleted lists. Tables of inputs should include: }
...
\NormalTok{If there is no application for one of these (default, min, or max particularly), do not leave the table cell blank. Please include "{-}{-}" or "NA" depending on what makes the most sense. }
...
See Equation~\ref{eq-an-nrc-2-tagged}.
...
pen\_name \textbar{} The name or identifier of a given pen \textbar{} NA
\textbar{} \textbar{} \textbar{}

animal\_combination \textbar{} The valid combinations of animal types
that can be in a pen. CALF = Calves; GROWING = HeiferI's and HeiferII's;
CLOSE\_UP = HeiferIII's and Dry Cows; LAC\_COWS = Lactating Cows
\textbar{} \textbar{} CALF, GROWING CLOSE\_UP, LAC\_COW \textbar{}

vertical\_dist\_to\_milking\_parlor \textbar{} The elevation gain (in
meters) between the pen and the milking parlor \textbar{} 0.1 \textbar{}
0 \textbar{} NA \textbar{}

horizontal\_dist\_to\_milking\_parlor \textbar{} The distance (in
meters) between the pen and the milking parlor \textbar{} 10 \textbar{}
0 \textbar{} NA \textbar{}

number\_of\_stalls \textbar{} The number of stalls in the pen \textbar{}
1000 \textbar{} 0 \textbar{} NA \textbar{}

pen\_type \textbar{} The type of pen (freestall, tiestall, open lot,
compost bedded pack barn) \textbar{} freestall \textbar{} freestall,
tiestall, open lot, compost bedded pack barn \textbar{}

max\_stocking\_density \textbar{} The maximum ratio of the number of
animals in the pen to the number of stalls in the pen \textbar{} 1.2
\textbar{} 0.5 \textbar{} 5 \textbar{}

manure\_management\_scenario\_id \textbar{} The ID number of the manure
management practices that are used for this pen (scenarios are defined
in manure management schema) \textbar{} 0 \textbar{} 0 \textbar{} NA
\textbar{}

: User inputs in the animal input file that influence pen grouping. The
user must define at least 3 pens and for each pen, key inputs are
outlined here. \{\#tbl-animal-grp-inputs\}
...
\tightlist
\item
  number\_of\_animals\_in\_pen\_{[}id{]}\_{[}AnimalCombination{]}
  reports the number of animals in each pen each day.
\item
  ration\_per\_animals\_for\_pen\_{[}id{]}\_{[}AnimalCombination{]} -
  reports average dry matter intake of an animal in the pen at the time
  of the ration formulation.
\item
  ration\_per\_animals\_for\_pen\_{[}id{]}\_{[}AnimalCombination{]}.{[}RUFAS\_feed\_id{]}
  - reports the amount of each feed that is delivered per animal in the
  pen
\item
  ration\_nutrient\_amount\_for\_pen\_\_{[}AnimalCombination{]}.{[}nutrient{]}
