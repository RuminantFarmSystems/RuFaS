...
This is a section that should be included in all modules. Below is
correct subsection structure outlining templates for Figures, Tables,
and Equations with proper tagging templates.
...
\subsection{Examples of Equations}\label{examples-of-equations-1}
...
\subsection{Example of a Figure}\label{example-of-a-figure-2}

\includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio]{resources/manure.png}

\subsection{Example of a Table}\label{example-of-a-table-2}
