...
The assignment of manure generated in the Animal Module (which also reflects the quantity of bedding used) to its destination in the Manure Module occurs in the Animal Module. See the \colorbox{red}{Animal to Manure Connection} section for more information. 
...
Detailed descriptions are outlined in the \colorbox{red}{Slurry Storage} section of this module. Precipitation volume for anaerobic lagoons that are uncovered or have a crust is calculated as follows:\\
        \vspace{0.5cm}
