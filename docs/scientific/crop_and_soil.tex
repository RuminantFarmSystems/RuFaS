...
\(C_{slow\_to\_passive}=C_{slow\ decomp} * frac\_C_{slow\ passive}\)
    \end{center}
        ...
        \begin{itemize}
            ...
            \item C\textsubscript{slow\_to\_CO_2} = slow C lost as CO\textsubscript{2} during decomposition (kg ha\textsuperscript{-1})
        \end{itemize}
        \vspace{0.5cm}
...
\(AG_{met}\_to\_C_{active\ act}=AG_{met}\_to\_C_{active} * (1-frac\_ CO2_{met\_to\_active})\)
    ...
    \end{center}
        ...
        \begin{itemize}
            \item frac\_CO2\textsubscript{met_to_active} = rate of C dioxide loss during transformation of metabolic to active C (0.55, \cite{parton1987analysis})
...
\(AG_{struct}\_to\_C_{slow\ act}=AG_{struct}\_to\_C_{slow} * (1-frac\_CO2_{struct\_to\_slow})\)
    ...
    \end{center}
        ...
        \begin{itemize}
            ...
            \item frac\_CO2\textsubscript{struct_to_slow} = rate of CO2 loss during transformation of structural to slow C (0.3, Partonet al. 1987)
        \end{itemize}
        \vspace{0.5cm}
