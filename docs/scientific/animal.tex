...
\paragraph{NASEM: Calculating Nutrient Requirements of Dairy Cattle: Eighth Revised Edition} 
    ...
    The maintenance requirement is calculated based on metabolic body weight (MBW, body weight\(^{0.75}\)) adjusted for the tissues associated with pregnancy. For details about the variables included in each calculation, please refer to the [energy requirements key](#tbl-an-energy-var).
    \vspace{0.2cm}
...
Total volatile solids excreted by a lactating cow (kg/d) 
    ...
    \end{center}
        \vspace{0.5cm} 
            ...
            \vspace{0.2cm}
\textit{Note: Minimum DMI is 7.1 kg/d per cow \parencite{appuhamy2018}.}
            \vspace{0.5cm}
