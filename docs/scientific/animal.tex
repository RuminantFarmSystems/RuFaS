...
\textit{Growth}
    ...
    \vspace{0.5cm}
            ...
            {\raggedleft \textbf{[AN.SUP.31]}\par}
            \vspace{0.5cm}
...
\begin{tabular}{@{} L{5cm} L{7cm} C{2cm} C{2cm} C{2cm} @{}}
...
\begin{tabular}{@{} L{3.5cm} L{5.5cm} L{4.5cm} C{2cm} C{2cm} C{2cm} @{}}
...
\multirow{3}{*}{\parbox{3cm}{\textbf{User\_defined\_ration\_percentages}}}
...
\paragraph{Introduction}
The user-defined ration methodology follows the same process as described in the Automated ration formulation methodology, with the addition of the inputs found in this section, as described in the Methodology below.
...
\begin{tabular}{@{} L{3.5cm} L{5.5cm} L{4.5cm} C{2cm} C{2cm} @{}}
...
\renewcommand{\arraystretch}{1.4} % More vertical space between rows
\begin{longtable}{@{} L{6cm} L{12cm} C{2cm} C{2cm} C{2cm} @{}}
...
\vspace{-0.25cm}
    ...
    \end{center}
        \vspace{0.5cm} 
            ...
            {\raggedleft \textbf{[AN.MET.6]}\cite{Niu2018}\par}
            \vspace{0.5cm}
