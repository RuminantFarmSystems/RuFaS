...
\subsubsecion{Nutrient Requirements of Dairy Cattle (NRC)} \label{sec:NRC}
...
\multicolumn{3}{l}{\textsuperscript{1} \cite{nrc2021}} 
...
\multicolumn{3}{l}{\textsuperscript{1} \cite{nrc2001}} 
