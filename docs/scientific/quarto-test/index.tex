...
\chapter{Use alphanumeric equation
...
\includegraphics[width=0.35\linewidth,height=\textheight,keepaspectratio,alt={Animal module icon}]{resources/animal1.png}
