...
*\ :math:`{norm}_{i} = \left( \frac{{NE}_{i} - min\left( {NE}_{} \right)}{\max\left( {NE}_{} \right) - min\left( {NE}_{} \right)} \right) +`\ :math:`\left( \frac{{MP}_{i} - min\left( {MP}_{} \right)}{\max\left( {MP}_{} \right) - min\left( {MP}_{} \right)} \right) +`\ :math:`\left( \frac{{MY}_{i} - min\left( {MY}_{} \right)}{\max\left( {MY}_{} \right) - min\left( {MY}_{} \right)} \right)`
[A.#.D.3]
