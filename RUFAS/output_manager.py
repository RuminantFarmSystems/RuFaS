...
class OutputManager(object):
    ...
    def __init__(self) -> None:
        if OutputManager.__instance is None:
            ...
            self._get_simulation_day_callback: Callable[[], int] | None = None
    ...
    def add_variable(self, name: str, value: Any, info_map: Dict[str, Any]) -> None:
        ...
        info_map["simulation_day"] : int, optional
            If present, overrides any autogenerated simulation day
        """

        if "simulation_day" not in info_map and self._get_simulation_day_callback is not None:
            info_map["simulation_day"] = self._get_simulation_day_callback()
    ...
    def set_get_simulation_day_callback(self, callback: Callable[[], int] | None) -> None:
        """
        Set the callback for getting the simulation day.

        Parameters
        ----------
        callback : Callable[[], int]
            The callback for getting the simulation day.
        """

        self._get_simulation_day_callback = callback
