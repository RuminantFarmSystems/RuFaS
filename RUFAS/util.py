...
class DatabaseReader:
    ...
    def get_values(self, table, distinct=False, cols=None, identifier=None,
                   desired_rows=None):
        try:
            ...
            print("get_values(): The program has encountered the following "
                  "exception while connecting to and querying table ",
