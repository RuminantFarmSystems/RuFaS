...
class Feed:
    ...
    def forage_inventory_plan(self, storage, animal_management):
        """
        Description:
    ...
    def daily_feed_storage(self, fields, animal_management):
        """
        Description:
    ...
    # The functions below are Feed class functions that provide utillization of
    # the feed databse
