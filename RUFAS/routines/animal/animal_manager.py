...
class AnimalManager:
    ...
    def __init__(self, data, config, feed, weather: Weather, time: Time):
        ...
        self.init_pens(
            data["pen_information"],
            data["herd_information"],
            data["manure_management_scenarios"],
        )
    ...
    def init_pens(
        self, all_pen_data: list, herd_data: Dict[str, Any], manure_management_scenarios
    ) -> None:
        """
        ...
        for pen_data in all_pen_data:
            ...
            pen_data["animal_combination"] = Pen.AnimalCombination[
    ...
    def generate_animal_output(self, animal_type: str, index: int):
        ...
        return (
            ...
            is_cow,
            {
                ...
                "synch_ed_method_h": None
                if not is_heifer_repr
                else animal.synch_ed_method_h,
    ...
    def get_life_cycle_output(
        ...
        for i in indices:
            animal, is_cow, output["heiferIs"][i] = self.generate_animal_output(
                "heiferI", i
            )
        ...
        for i in indices:
            animal, is_cow, output["heiferIIs"][i] = self.generate_animal_output(
                "heiferII", i
            )
        ...
        for i in indices:
            animal, is_cow, output["heiferIIIs"][i] = self.generate_animal_output(
                "heiferIII", i
            )
        ...
        for i in indices:
            animal, is_cow, output["sold_heifers"][i] = self.generate_animal_output(
                "sold_heifer", i
            )
        ...
        for i in indices:
            animal, is_cow, output["culled_cows"][i] = self.generate_animal_output(
                "culled_cow", i
            )
