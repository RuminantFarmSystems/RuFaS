...
def calculate_requirements(BW, MW, DOP, housing, distance, parity, CI, TP_Milk,
    ...
    # ---------------------
    MP_req = MPm + MPg + MPpreg + MPlact       #[A.Cow.B.7]
    ...
    DMIest = (0.372 * FCM + 0.0968 * BW**0.75) * (1- math.exp(-0.192 *((DIM/7) + 3.67))) #[A.Cow.D.2]

    # Requirements summary dictionary
    requirements = {'NEmaint' : NEmaint, 'NEa' : NEa, 'NEg' : NEg, 'NEpreg' : NEpreg,
