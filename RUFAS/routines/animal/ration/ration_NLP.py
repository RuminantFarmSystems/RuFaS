...
class RationOptimizer:
    ...
    def optimize(self, animal_combination, available_feeds: Dict) -> None:
        """
    ...
    def optimization(self, requirements, available_feeds, animal_combination):
        ...
        if solution is None:
            ...
            ration_vals = self.get_ration_vals(solution.x)
