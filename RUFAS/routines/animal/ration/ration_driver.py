...
from RUFAS.routines.animal.animal_grouping_scenarios import \
    AnimalGroupingScenario
...
class RationManager:
    ...
    def formulate_ration(
        cls, pen: Pen, available_feeds: AvailableFeedsTypedDict, animal_grouping_scenario: AnimalGroupingScenario
