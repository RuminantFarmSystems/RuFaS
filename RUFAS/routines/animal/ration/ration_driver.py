...
def ration_supply(ration, available_feeds, ration_report, body_weight):
    ration = ration.copy()
    for non_numeric_key in ['status', 'objective']:
        if non_numeric_key in ration:
            del ration[non_numeric_key]
    ...
    supply_report['Metabolizable_protein'] = \
         get_Metabolizable_protein(ration, available_feeds, ration_report, body_weight)
    
    return supply_report


def get_TDN_discount(ration_report, body_weight):
    """
...
def get_DE(val, feed_item_info, ration_report, body_weight):
    """
    
    """
    DE_act = feed_item_info['DE'] * get_TDN_discount(ration_report, body_weight)
    return DE_act

def get_ME(val, feed_item_info, ration_report, body_weight):
    """
    
    """
    DE_act = get_DE(val, feed_item_info, ration_report, body_weight)
...
def get_NE_maintenance_and_activity(val, feed_item_info, ration_report, body_weight):
    """
    
    """
    ME_item = get_ME(val, feed_item_info, ration_report, body_weight)
    # turn ME into NEm
...
def get_NE_lactation(val, feed_item_info, ration_report, body_weight):
    """
...
def get_NE_growth(val, feed_item_info, ration_report, body_weight):
    """
...
def get_Calcium(val, feed_item_info, ration_report, body_weight):
    """
...
def get_Phosphorus(val, feed_item_info, ration_report, body_weight):
    """
...
def get_Metabolizable_protein(ration, available_feeds, ration_report, body_weight):
    """
...
def get_Forage_NDF_percent(val, feed_item_info, ration_report, body_weight):
    """
...
def get_Fat(val, feed_item_info, ration_report, body_weight):
    """
...
def get_Fat_percentage(val, feed_item_info, ration_report, body_weight):
    """
