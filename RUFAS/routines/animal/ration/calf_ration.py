...
class CalfRationManager:
    ...
    Note that the ration formulated is a fixed ration, and the animal requirements are scarcely used
    ...
    @classmethod
    def calc_requirements(cls, calf, feed, temp, wean_day, wean_length, milk_type):
        """
