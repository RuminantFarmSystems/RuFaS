...
class AnimalRequirements:
        ...
        if recalc:
            ...
            for animal in pen.animals_in_pen:
                ...
                if animal_type in [AnimalType.HEIFER_I]:
                    req = self.calc_rqmts(body_weight = animal.body_weight,
                ...
                if animal_type in [AnimalType.LAC_COW]:
                    ...
                    NEa_val = self.energy_activity_rqmts(animal.body_weight,
                                                                        pen.housing_type,
    ...
    def calc_rqmts(self, body_weight: float, mature_body_weight: float, day_of_pregnancy: int,
        ...
        if AnimalBase.config['nutrient_standard'] == 'NRC':
            net_energy_maintenance, conceptus_weight, calf_birth_weight = self.calculate_NRC_energy_maintenance_requirements(
                ...
                animal_type)
            net_energy_growth, average_daily_gain, equivalent_shrunk_body_weight = self.calculate_NRC_energy_growth_requirements(
    ...
    def calculate_NASEM_energy_maintenance_requirements(self, body_weight: float, mature_body_weight: float,
    ...
    def calculate_NRC_energy_growth_requirements(self, body_weight: float, mature_body_weight: float, conceptus_weight: float,
    ...
    def calculate_NASEM_energy_growth_requirements(self,
    ...
    def calculate_NRC_energy_pregnancy_requirements(self, day_of_pregnancy: Optional[int], calf_birth_weight: float) -> float:
    ...
    def calculate_NASEM_energy_pregnancy_requirements(self, lactating: bool, day_of_pregnancy: Optional[int],
    ...
    def calculate_NRC_energy_lactation_requirements(self, animal_type: AnimalType, milk_fat: float, milk_true_protein: float,
    ...
    def calculate_NASEM_energy_lactation_requirements(self, animal_type: AnimalType, milk_fat: float, milk_true_protein: float,
                                                    milk_lactose: float, milk_production: float) -> float:
    ...
    def calculate_NRC_calcium_requirements(self, body_weight: float, mature_body_weight: float, day_of_pregnancy: Optional[int],
    ...
    def calculate_NASEM_calcium_requirements(self, body_weight: float, mature_body_weight: float,
    ...
    def calculate_NASEM_phosphorus_requirements(self, body_weight: float, mature_body_weight: float, animal_type: AnimalType,
                                                day_of_pregnancy: Optional[int], average_daily_gain: float,
                                                dry_matter_intake_estimate: float, milk_true_protein: float,
                                                milk_production: float, parity: int) -> float:
