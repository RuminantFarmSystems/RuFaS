...
from RUFAS.routines.animal.animal_manager import AnimalGroupingScenario
...
class AnimalRequirements:
    ...
    def set_requirements(
        self, pen: Pen, animal_grouping_scenario: AnimalGroupingScenario, recalc: bool
    ):
        """
        ...
        for animal_id in pen.animals_in_pen:
            ...
            if animal_type in [AnimalType.LAC_COW]:
                ...
                animal.DMDP_requirement = (
                    (req["MP_requirement"]) / animal.DMIest_requirement
                )
    ...
    def calculate_NASEM_protein_requirements(
        ...
        NPEndUrin: float = (
            53 * GeneralConstants.NITROGEN_TO_PROTEIN * body_weight * 0.001
        )
    ...
    def energy_activity_rqmts(
        self, body_weight: float, housing: str, distance: float
    ) -> float:
        """
