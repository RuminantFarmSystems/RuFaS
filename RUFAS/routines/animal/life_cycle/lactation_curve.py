...
class LactationCurve: 
  def __init__(self):
    self.fips_region = im.get_data("lactation.fips_region")
  ...
  def get_y_values_wood_curve(self, t:float, parameter_a:float, parameter_b:float, parameter_c:float) -> np.float64:
  ...
  def get_wood_parameters(self, lactation_group:str=None, year:str = None, month:str=None, region:str=None,milking_frequency:str=None, MY_305d:str=None) -> tuple:
    parameter_a = 19.9
  ...
  def set_lactation_curve_parameters(self) -> tuple[tuple, tuple, tuple]:
    ...
    return self.get_wood_parameters(lactation_group="1", year=self.year, region=self.region, milking_frequency=self.milking_freq, MY_305d=P1_305), self.get_wood_parameters(lactation_group="2", year=self.year, region=self.region, milking_frequency=self.milking_freq, MY_305d=P2_305), self.get_wood_parameters(lactation_group="3", year=self.year, region=self.region, milking_frequency=self.milking_freq, MY_305d=P3_305)