...
# Importing the five manure excretion types
import RUFAS.routines.animal as animal
from RUFAS.routines.animal import manure
from RUFAS.routines.animal.manure import calf_manure_excretion, \
  dry_cow_manure_excretion, general_manure, growing_heifer_manure_excretion, \
    lactating_cow_manure_excretion
from RUFAS.routines.animal.manure.calf_manure_excretion import manure_calculations as calf_manure_calculations
from RUFAS.routines.animal.manure.dry_cow_manure_excretion import manure_calculations as dry_cow_manure_calculations
from RUFAS.routines.animal.manure.growing_heifer_manure_excretion import manure_calculations as growing_heifer_manure_calculations

# Placeholder arguments for the calf function
calf_bw = 0
calf_p_feces_excrt = 0 
calf_p_urine = 0

# Calling the calf manure_calculations function
calf_manure_values = calf_manure_calculations(calf_bw, calf_p_feces_excrt, 
  calf_p_urine)

# Two return values for calf_manure_calculations
calf_manure_p_excrt = (calf_manure_values[0]) 
calf_manure_dictionary = calf_manure_values[1]

# All of the values from the dictionary returned from calf_manure_excretion.py
calf_U = calf_manure_dictionary["U"]
calf_tan_s = calf_manure_dictionary["TAN_s"]
calf_MN = calf_manure_dictionary["MN"]
calf_Mkg = calf_manure_dictionary["Mkg"]
calf_TSd = calf_manure_dictionary["TSd"]
calf_VSd = calf_manure_dictionary["VSd"]
calf_VSnd = calf_manure_dictionary["VSnd"]
calf_WIP_frac = calf_manure_dictionary["WIP_frac"]
calf_WOP_frac = calf_manure_dictionary["WOP_frac"]
calf_p_excrt_manure = calf_manure_dictionary["p_excrt_manure"]
calf_p_frac = calf_manure_dictionary["p_frac"]
calf_K_manure = calf_manure_dictionary["K_manure"]
calf_CH4_manure = calf_manure_dictionary["CH4_manure"]


# Placeholder args for dry_cow function
ration_formulation = 0
feed = 0
bw = 0
milk_prod = 0
p_feces_excrt = 0
...
# Calling the dry_cow_manure_calculations function
dry_cow_manure_values = dry_cow_manure_calculations(ration_formulation, feed, bw, 
  milk_prod, p_feces_excrt, p_urine, ME_intake)

dry_cow_manure_p_excrt = (dry_cow_manure_values[0]) 
dry_cow_manure_dictionary = dry_cow_manure_values[1]

# All of the values from the dry cow dictionary
dry_cow_U = dry_cow_manure_dictionary["U"]
dry_cow_tan_s = dry_cow_manure_dictionary["TAN_s"]
dry_cow_MN = dry_cow_manure_dictionary["MN"]
dry_cow_Mkg = dry_cow_manure_dictionary["Mkg"]
dry_cow_TSd = dry_cow_manure_dictionary["TSd"]
dry_cow_VSd = dry_cow_manure_dictionary["VSd"]
dry_cow_VSnd = dry_cow_manure_dictionary["VSnd"]
dry_cow_WIP_frac = dry_cow_manure_dictionary["WIP_frac"]
dry_cow_WOP_frac = dry_cow_manure_dictionary["WOP_frac"]
dry_cow_p_excrt_manure = dry_cow_manure_dictionary["p_excrt_manure"]
dry_cow_p_frac = dry_cow_manure_dictionary["p_frac"]
dry_cow_K_manure = dry_cow_manure_dictionary["K_manure"]
dry_cow_CH4_manure = dry_cow_manure_dictionary["CH4_manure"]

# placeholders for growing heifer
growing_heifer_ration_formulation = 0
growing_heifer_feed = 0
growing_heifer_bw = 0
growing_heifer_p_feces_excrt = 0
growing_heifer_p_urine = 0

growing_heifer_manure_values = growing_heifer_manure_calculations(growing_heifer_ration_formulation, 
  growing_heifer_feed, growing_heifer_bw, growing_heifer_p_feces_excrt, 
  growing_heifer_p_urine)


growing_heifer_manure_p_excrt = (growing_heifer_manure_values[0]) 
growing_heifer_manure_dictionary = growing_heifer_manure_values[1]

growing_heifer_U = growing_heifer_manure_dictionary["U"]
growing_heifer_tan_s = growing_heifer_manure_dictionary["TAN_s"]
growing_heifer_MN = growing_heifer_manure_dictionary["MN"]
growing_heifer_Mkg = growing_heifer_manure_dictionary["Mkg"]
growing_heifer_TSd = growing_heifer_manure_dictionary["TSd"]
growing_heifer_VSd = growing_heifer_manure_dictionary["VSd"]
growing_heifer_VSnd = growing_heifer_manure_dictionary["VSnd"]
growing_heifer_WIP_frac = growing_heifer_manure_dictionary["WIP_frac"]
growing_heifer_WOP_frac = growing_heifer_manure_dictionary["WOP_frac"]
growing_heifer_p_excrt_manure = growing_heifer_manure_dictionary["p_excrt_manure"]
growing_heifer_p_frac = growing_heifer_manure_dictionary["p_frac"]
growing_heifer_K_manure = growing_heifer_manure_dictionary["K_manure"]
growing_heifer_CH4_manure = growing_heifer_manure_dictionary["CH4_manure"]