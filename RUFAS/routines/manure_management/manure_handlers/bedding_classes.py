...
class BeddingFactory:
    @classmethod
    def get_instance(cls, bedding_type: str, bedding_config: Optional[BeddingConfig] = None) -> Bedding:
        enum_to_init_data: Dict[BeddingEnum, Tuple[Type[Bedding], BeddingConfig]] = {
        ...
        if bedding_config:
            return bedding_class(**asdict(bedding_config))

        init_data = enum_to_init_data[bedding_enum][1]
        return bedding_class(**asdict(init_data))
