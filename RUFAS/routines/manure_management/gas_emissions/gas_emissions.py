...
class GasEmissions:
    ...
    def get_r_storage_for_manure_without_crust() -> float:
        ...
        Notes
        -----
        If this is a only constant, then move it to the Constants class above.
    ...
    def get_r_storage_for_solid_manure() -> float:
        ...
        Notes
        -----
        If this is only a constant, then move it to the Constants class above.
...
=======
    def calc_Kmc(temp_in_K: float) -> float:
        """
        Returns the Michaelis-Menten coefficient (Kmc), kg N/m3 mixture.
>>>>>>> 9b08aea7c0a4b0ad91940e02072fd34c54258740
    ...
    def calc_E_N20_manure(EF_n20, A_storage):
        ...
        Notes
        -----
        For stacked manure with a greater DM content, an emission factor of 0.005 kg N2O-N /(kg N excreted)
          when a crust does not form, no N2O is formed and emitted. This occurs if the manure DM contents less than
          8%, manure is loaded daily onto the top surface of the
