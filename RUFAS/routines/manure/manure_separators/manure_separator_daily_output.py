...
class ManureSeparatorDailyOutput(LiquidManurePortionProtocol):
    ...
    final_solids_wet_mass_unit: str = MeasurementUnits.KILOGRAMS.value

    final_solids_wet_mass_volume: float = field(init=False)
    final_solids_wet_mass_volume_unit: str = MeasurementUnits.CUBIC_METERS.value
    ...
    final_daily_volume_unit: str = MeasurementUnits.CUBIC_METERS.value
