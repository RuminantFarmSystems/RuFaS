...
class ExtendedEnum(Enum):
    ...
    for a specific member that matches or partially matches a simple string.
    ...
    @classmethod
    def get_default_type(cls) -> ExtendedEnum:
        ...
        Notes:
            If DEFAULT has some other contextual meaning, then override this method.
