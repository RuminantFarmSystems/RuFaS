...
class ManureHandlerDailyOutput(LiquidManurePortionProtocol):
    ...
    housing_methane_unit: str = MeasurementUnits.KILOGRAMS.value

    housing_carbon_dioxide: float = 0.0
    housing_carbon_dioxide_unit: str = MeasurementUnits.KILOGRAMS.value

    housing_ammonia: float = 0.0
    housing_ammonia_unit: str = MeasurementUnits.KILOGRAMS.value

    manure_volume: float = 0.0
    manure_volume_unit: str = MeasurementUnits.CUBIC_METERS.value

    cleaning_water_volume: float = 0.0
    cleaning_water_volume_unit: str = MeasurementUnits.CUBIC_METERS.value

    total_bedding_volume: float = 0.0
    total_bedding_volume_unit: str = MeasurementUnits.CUBIC_METERS.value

    total_bedding_mass: float = 0.0
    total_bedding_mass_unit: str = MeasurementUnits.KILOGRAMS.value

    total_water_volume_in_milking_parlor: float = 0.0
    total_water_volume_in_milking_parlor_unit: str = MeasurementUnits.CUBIC_METERS.value
    ...
    tempC: float = 0.0
    tempC_unit: str = MeasurementUnits.DEGREES_CELSIUS.value

    num_animals: int = -1
    num_animals_unit: str = MeasurementUnits.UNITLESS.value
