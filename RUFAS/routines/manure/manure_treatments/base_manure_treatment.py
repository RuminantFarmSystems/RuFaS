...
class BaseManureTreatment(ABC):
    ...
    def calculate_cover_and_flare_methane(methane_loss: float) -> tuple[float, float]:
        ...
        """
        storage_methane_burned = methane_loss * ManureConstants.METHANE_DESTRUCTION_EFFICIENCY *  GeneralConstants.PERCENTAGE_TO_FRACTION
        adjusted_methane_loss = methane_loss * (1 - ManureConstants.METHANE_DESTRUCTION_EFFICIENCY *  GeneralConstants.PERCENTAGE_TO_FRACTION)
