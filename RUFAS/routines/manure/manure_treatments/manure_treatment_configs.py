...
class DefaultManureTreatmentConfigFactory:
    ...
    SLURRY_STORAGE_UNDERFLOOR_CONFIG = ManureTreatmentConfig(
        total_solids_removal_efficiency_for_treatment=0.0,  # Between 10-30%
    ...
    ANAEROBIC_DIGESTION_CONFIG = ManureTreatmentConfig(
        ...
        sludge_accumulation_volume_fraction=0.0,  # Sludge Accumulation volume fraction 2-4% of VS loaded
