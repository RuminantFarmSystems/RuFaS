...
class ManureTreatmentConfig:
    ...
    anaerobic_digestion_methane_leakage_fraction : float, default 0.0
        Fraction of methane generated that leaks from the anaerobic digester on a daily basis.
    storage_time_period:
    ...
    anaerobic_digestion_methane_leakage_fraction: float = 0.0
