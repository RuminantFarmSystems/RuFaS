...
class FieldManureManager:
    ...
    def use(self, field_manure_data: FieldManureData) -> None:
    ...
    def use_fraction(self, fraction: float) -> None:
        ...
        """
        self.use(fraction * self._field_manure_data)
    ...
    def calc_liquid_manure_volume_needed(cls, nutrients: FieldManureDataLiquidNutrients) \
        ...
        nutrients : FieldManureDataLiquidNutrients
            The nutrient requirements to meet.

        Returns
        -------
        float
            The volume of liquid manure needed to meet the given nutrient requirements.

        """
        # TODO: Implement the correct calculation
        return 9.0 * min(nutrients.liquid_manure_nitrogen,
                         nutrients.liquid_manure_phosphorus,
                         nutrients.liquid_manure_potassium)

    @classmethod
    def calc_sludge_manure_volume_needed(cls, nutrients: FieldManureDataSludgeNutrients) \
            -> float:
        """Calculates the volume of sludge manure needed to meet the given nutrient requirements.
        ...
        -------
        float
            The volume of sludge manure needed to meet the given nutrient requirements.

        """
        # TODO: Implement the correct calculation
        return 9.0 * min(nutrients.sludge_manure_nitrogen,
                         nutrients.sludge_manure_phosphorus,
                         nutrients.sludge_manure_potassium)

    @classmethod
    def calc_liquid_manure_mass_needed(cls, nutrients: FieldManureDataLiquidNutrients) -> float:
        """Calculates the mass of liquid manure needed to meet the given nutrient requirements.
        ...
        -------
        float
            The mass of liquid manure needed to meet the given nutrient requirements.

        """
        return cls.calc_liquid_manure_volume_needed(nutrients) * ManureConstants.MANURE_DENSITY

    @classmethod
    def calc_sludge_manure_mass_needed(cls, nutrients: FieldManureDataSludgeNutrients) -> float:
        """Calculates the mass of sludge manure needed to meet the given nutrient requirements.
        ...
        -------
        float
            The mass of sludge manure needed to meet the given nutrient requirements.

        """
        return cls.calc_sludge_manure_volume_needed(nutrients) * ManureConstants.MANURE_DENSITY

    def use_liquid_manure_nutrients(self, nutrients: FieldManureDataLiquidNutrients) -> None:
        """Uses the given liquid manure nutrients.

        First, the volume of liquid manure needed to meet the given nutrient requirements is calculated.
        ...
        """
        self.use(FieldManureData(
            liquid_manure_nitrogen=nutrients.liquid_manure_nitrogen,
            liquid_manure_potassium=nutrients.liquid_manure_potassium,
            liquid_manure_phosphorus=nutrients.liquid_manure_phosphorus,
            liquid_manure_volume=self.calc_liquid_manure_volume_needed(nutrients),
        ))

    def use_sludge_manure_nutrients(self, nutrients: FieldManureDataSludgeNutrients) -> None:
        """Uses the given sludge manure nutrients.

        First, the volume of sludge manure needed to meet the given nutrient requirements is calculated.
        ...
        """
        self.use(FieldManureData(
            sludge_manure_nitrogen=nutrients.sludge_manure_nitrogen,
            sludge_manure_phosphorus=nutrients.sludge_manure_phosphorus,
            sludge_manure_potassium=nutrients.sludge_manure_potassium,
            sludge_manure_volume=self.calc_sludge_manure_volume_needed(nutrients),
        ))


if __name__ == '__main__':
    # Toy examples
    data1 = FieldManureData(
        liquid_manure_nitrogen=1,
        liquid_manure_phosphorus=2,
        liquid_manure_potassium=3,
        liquid_manure_volume=4,
        sludge_manure_nitrogen=5,
        sludge_manure_phosphorus=6,
        sludge_manure_potassium=7,
        sludge_manure_volume=8,
    )
    data2 = FieldManureData(
        liquid_manure_nitrogen=10,
        liquid_manure_phosphorus=11,
        liquid_manure_potassium=12,
        liquid_manure_volume=13,
        sludge_manure_nitrogen=14,
        sludge_manure_phosphorus=15,
        sludge_manure_potassium=16,
        sludge_manure_volume=17,
    )
    manager = FieldManureManager(data1)
    print(manager.field_manure_data)
    manager.add(data2)
    print(manager.field_manure_data)

    data3 = FieldManureData(
        liquid_manure_nitrogen=15,  # more than what is available, should be set to zero
        liquid_manure_phosphorus=4,
        liquid_manure_potassium=5,
        liquid_manure_volume=6,
        sludge_manure_nitrogen=7,
        sludge_manure_phosphorus=8,
        sludge_manure_potassium=9,
        sludge_manure_volume=10,
    )
    manager.use(data3)
    print(manager.field_manure_data)

    # use a fraction of current manure, manually
    data4 = 0.25 * manager.field_manure_data
    manager.use(data4)
    print(manager.field_manure_data)

    # call the use_fraction method
    manager.use_fraction(0.5)
    print(manager.field_manure_data)

    # call the use_all method
    manager.use_all()
    print(manager.field_manure_data)

    data5 = FieldManureData(
        liquid_manure_nitrogen=20,
        liquid_manure_phosphorus=21,
        liquid_manure_potassium=22,
        liquid_manure_volume=23,
        sludge_manure_nitrogen=24,
        sludge_manure_phosphorus=25,
        sludge_manure_potassium=26,
        sludge_manure_volume=27,
    )
    manager.add(data5)
    # Use only the liquid nutrients
    data6 = FieldManureData(
        liquid_manure_nitrogen=5,
        liquid_manure_phosphorus=6,
        liquid_manure_potassium=7,
        liquid_manure_volume=8,
    )
    manager.use(data6)
    print(manager.field_manure_data)

    # A probably more logical example
    manager = FieldManureManager(FieldManureData(
        liquid_manure_nitrogen=1,
        liquid_manure_phosphorus=0.7,
        liquid_manure_potassium=0.4,
        liquid_manure_volume=10,
    ))
    data7 = FieldManureData(
        liquid_manure_nitrogen=0.3,
        liquid_manure_phosphorus=0.2,
        liquid_manure_potassium=0.1,
    )
    print(FieldManureManager.calc_liquid_manure_volume_needed(data7))
    manager.use_liquid_manure_nutrients(data7)
    print(manager.field_manure_data)
