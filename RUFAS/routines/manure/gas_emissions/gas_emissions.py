...
class GasEmissions:
    @staticmethod
    def calc_E_CH4_slurry_storage(Ts, enclosed=False, tempC=15.0, Pvs=0.68, Bo=0.2, E_CH4_pot=0.48, n_eff=0.99,
    ...
    @classmethod
    def calc_E_CH4_floor(cls, pen, hours=24, t_min=20.0, t_max=25.0) -> float:
    ...
    @classmethod
    def calc_E_C02_floor(cls, pen, hours=24, t_min=20.0, t_max=25.0) -> float:
    ...
    @classmethod
    def calc_E_NH3_housing(cls, pen, TAN: float, U: float, tempC: float, p=990.0, pH=7.7) -> float:
