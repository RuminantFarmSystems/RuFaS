...
class PenManure:
    ...
    def get_instance(cls, animal_manure: AnimalManureExcretions, num_animals: int) -> PenManure:
        ...
        return cls(
            ...
            degradable_volatile_solids=animal_manure.manure_degradable_volatile_solids,
            non_degradable_volatile_solids=animal_manure.manure_non_degradable_volatile_solids,
