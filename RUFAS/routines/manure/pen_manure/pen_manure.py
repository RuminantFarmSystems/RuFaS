...
class PenManure:
    ...
    urea_unit: str = AcceptableUnits.GRAMS_PER_LITER
    """Unit for urea"""

    urine: float = 0.0
    """Amount of urine in manure (kg)."""
    urine_unit: str = AcceptableUnits.KILOGRAMS
    """Unit for urine"""

    urine_total_ammoniacal_nitrogen: float = 0.0
    """Amount of ammoniacal nitrogen concentration in urine (kg)."""
    urine_total_ammoniacal_nitrogen_unit: str = AcceptableUnits.KILOGRAMS
    ...
    manure_total_ammoniacal_nitrogen_unit: str = AcceptableUnits.KILOGRAMS
    """Unit for manure_total_ammoniacal_nitrogen"""

    urine_nitrogen: float = 0.0
    """Amount of nitrogen in urine (kg)."""
    urine_nitrogen_unit: str = AcceptableUnits.KILOGRAMS
    ...
    """Amount of manure (kg)."""
    manure_mass_unit: str = AcceptableUnits.KILOGRAMS
    ...
    inorganic_phosphorus_fraction_unit: str = AcceptableUnits.UNITLESS
    ...
    organic_phosphorus_fraction_unit: str = AcceptableUnits.UNITLESS
    ...
    non_water_inorganic_phosphorus_fraction_unit: str = AcceptableUnits.UNITLESS
    ...
    non_water_organic_phosphorus_fraction_unit: str = AcceptableUnits.UNITLESS
    ...
    phosphorus_fraction_unit: str = AcceptableUnits.UNITLESS
    ...
    enteric_methane_kg_unit: str = AcceptableUnits.KILOGRAMS_PER_DAY
