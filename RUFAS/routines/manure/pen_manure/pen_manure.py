...
class PenManure:
    ...
    urea_unit: str = MeasurementUnits.GRAMS_PER_LITER
    """Unit for urea"""

    urine: float = 0.0
    """Amount of urine in manure (kg)."""
    urine_unit: str = MeasurementUnits.KILOGRAMS
    """Unit for urine"""

    urine_total_ammoniacal_nitrogen: float = 0.0
    """Amount of ammoniacal nitrogen concentration in urine (kg)."""
    urine_total_ammoniacal_nitrogen_unit: str = MeasurementUnits.KILOGRAMS
    ...
    manure_total_ammoniacal_nitrogen_unit: str = MeasurementUnits.KILOGRAMS
    """Unit for manure_total_ammoniacal_nitrogen"""

    urine_nitrogen: float = 0.0
    """Amount of nitrogen in urine (kg)."""
    urine_nitrogen_unit: str = MeasurementUnits.KILOGRAMS
    """Unit for urine_nitrogen"""

    nitrogen: float = 0.0
    """Amount of nitrogen in manure (kg)."""
    nitrogen_unit: str = MeasurementUnits.KILOGRAMS
    """Unit for nitrogen"""

    manure_mass: float = 0.0
    """Amount of manure (kg)."""
    manure_mass_unit: str = MeasurementUnits.KILOGRAMS
    ...
    inorganic_phosphorus_fraction_unit: str = MeasurementUnits.UNITLESS
    ...
    organic_phosphorus_fraction_unit: str = MeasurementUnits.UNITLESS
    ...
    non_water_inorganic_phosphorus_fraction_unit: str = MeasurementUnits.UNITLESS
