...
def added_manure_P(soil, field_management, m_app):
    ...
    DM = m_app['DM']
    surface_fraction = m_app['surface_fraction']
    ...
    soil.SOP += field_management.manure_P_applied * W_fac * 0.75 * surface_fraction * S_fac
    soil.SIP += field_management.manure_P_applied * W_fac * 0.25 * surface_fraction * S_fac
