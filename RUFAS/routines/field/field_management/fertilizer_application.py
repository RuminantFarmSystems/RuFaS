...
def fertilizer_P(soil, field_management, fert_app):
    ...
    surface_fraction = fert_app['surface_fraction']
    ...
    # FM.3.B.1/2
    soil.fert_P_available += P_mass * 0.75 * surface_fraction
    soil.fert_P_released += P_mass * 0.25 * surface_fraction
    ...
    for layer in soil.soil_layers:
        ...
        if layer.bottom_depth_cm < depth:
            ...
            layer.labile_P += P_mass * soil.depth_fact * (1.0 - surface_fraction)
    ...
    soil.soil_layers[last_layer].labile_P += P_mass * soil.depth_fact * (1.0 - surface_fraction)
