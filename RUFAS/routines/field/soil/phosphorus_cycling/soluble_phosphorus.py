...
class SolublePhosphorus:
    ...
    def daily_update_routine(self, runoff: float, field_size: float) -> None:
        ...
        for layer_index in range(len(self.data.soil_layers)):
            ...
            phosphorus_percolated = self._determine_phosphorus_percolated_from_layer(
                ...
                current_layer.clay_proportion_content,
    ...
    @staticmethod
    def _determine_isotherm_slope(clay_proportion_content: float) -> float:
        """
        ...
        clay_proportion_content : float
            Proportion clay content of a soil layer, expressed in the range [0, 1.0] (unitless).
        ...
        """
        return 173.51 * clay_proportion_content + 8.48
    ...
    def _determine_phosphorus_percolated_from_layer(
        ...
        clay_proportion_content : float
            The clay content expressed of soil in this layer, expressed as a number in the range [0, 1.0] (unitless).
        percolated_water : float
        ...
        isotherm_slope = SolublePhosphorus._determine_isotherm_slope(clay_proportion_content)
