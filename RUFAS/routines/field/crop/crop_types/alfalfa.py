...
class Alfalfa(BaseCrop):
    ...
    def __init__(self, crop_name, data):
        ...
        self.PHU = 800  # TODO: Potential heat units unknown - GitHub Issue #154 (1)
        ...
        self.beta_w = 10  # water-use distribution parameter  # TODO: taken from corn - Github issue #154 (2)
        self.epco = 1
