    ...
    def send_daily_variables(self) -> None:
        ...
        for field in self.fields:
            ...
            om.add_variable(
                ...
                dict(info_map, **{"units": "ºC"}),
            )
            om.add_variable("water_sublimated", field.soil.data.water_sublimated, dict(info_map, **{"units": "mm"}))
            om.add_variable("cover_type", field.soil.data.cover_type, dict(info_map, **{"units": "unitless"}))
            om.add_variable(
            ...
            om.add_variable("nitrate_runoff", field.soil.data.nitrate_runoff, dict(info_map, **{"units": "kg/ha"}))
            om.add_variable("ammonium_runoff", field.soil.data.ammonium_runoff, dict(info_map, **{"units": "kg/ha"}))
            om.add_variable(
            ...
            for index, layer in enumerate(field.soil.data.soil_layers):
                ...
                om.add_variable("temperature", layer.temperature, dict(info_map, **{"units": "ºC"}))
            ...
            for crop in field.crops:
                ...
                om.add_variable("leaf_area_index", crop.data.leaf_area_index, dict(info_map, **{"units": "unitless"}))
                om.add_variable("canopy_height", crop.data.canopy_height, dict(info_map, **{"units": "m"}))
                om.add_variable("leaf_area_added", crop.data.leaf_area_added, dict(info_map, **{"units": "unitless"}))
                om.add_variable(
                ...
                om.add_variable("water_deficiency", crop.data.water_deficiency, dict(info_map, **{"units": "unitless"}))
