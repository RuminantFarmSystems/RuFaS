    ...
    def send_daily_variables(self) -> None:
        ...
        for field in self.fields:
            ...
            om.add_variable(
                ...
                dict(info_map, **{"units": MeasurementUnits.METRIC_TONS.value}),
            )
            om.add_variable(
                "accumulated_runoff",
            ...
            om.add_variable(
                "cover_type", field.soil.data.cover_type, dict(info_map, **{"units": MeasurementUnits.UNITLESS.value})
            )
            om.add_variable(
    ...
    def send_annual_variables(self) -> None:
        ...
        for field in self.fields:
            ...
            om.add_variable(
                ...
                dict(info_map, **{"units": MeasurementUnits.MILLIMETERS_PER_HECTARE.value}),
            )
            om.add_variable(
