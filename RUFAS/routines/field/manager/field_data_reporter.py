    ...
    def send_daily_variables(self) -> None:
        ...
        for field in self.fields:
            ...
            for crop in field.crops:
                ...
                om.add_variable("temp_stress", crop.data.temp_stress, dict(info_map, **{"units": MeasurementUnits.UNITLESS}))
                om.add_variable(
                    "nitrogen_stress",
                ...
                om.add_variable("is_growing", crop.data.is_growing, dict(info_map, **{"units": MeasurementUnits.UNITLESS}))
                om.add_variable("is_dormant", crop.data.is_dormant, dict(info_map, **{"units": MeasurementUnits.UNITLESS}))
                om.add_variable(
                    "leaf_area_index",
