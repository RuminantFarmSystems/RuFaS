...
class FieldDataReporter:
    ...
    def send_daily_variables(self) -> None:
        ...
        for field in self.fields:
            ...
            om.add_variable(
                "snow_content", field.soil.data.snow_content, dict(info_map, **{"units": MeasurementUnits.MILLIMETERS})
            )
            om.add_variable(
                "snow_melt", field.soil.data.snow_melt_amount, dict(info_map, **{"units": MeasurementUnits.MILLIMETERS})
            )
            om.add_variable(
            ...
            for index, layer in enumerate(field.soil.data.soil_layers):
                ...
                om.add_variable(
                    "temperature", layer.temperature, dict(info_map, **{"units": MeasurementUnits.DEGREES_CELSIUS})
                )
                om.add_variable(
                    "percolated_water",
                ...
                om.add_variable(
                    "water_content", layer.water_content, dict(info_map, **{"units": MeasurementUnits.MILLIMETERS})
                )
                om.add_variable(
            ...
            for crop in field.crops:
                ...
                om.add_variable(
                    "biomass", crop.data.biomass, dict(info_map, **{"units": MeasurementUnits.KILOGRAMS_PER_HECTARE})
                )
                om.add_variable(
                    "usable_light",
                ...
                om.add_variable(
                    "growth_factor", crop.data.growth_factor, dict(info_map, **{"units": MeasurementUnits.UNITLESS})
                )
                om.add_variable(
                ...
                om.add_variable(
                    "water_uptake", crop.data.water_uptake, dict(info_map, **{"units": MeasurementUnits.MILLIMETERS})
                )
                om.add_variable(
                ...
                om.add_variable(
                    "nitrogen_stress", crop.data.nitrogen_stress, dict(info_map, **{"units": MeasurementUnits.UNITLESS})
                )
                om.add_variable(
                    "phosphorus_stress",
                ...
                om.add_variable(
                    "heat_fraction", crop.data.heat_fraction, dict(info_map, **{"units": MeasurementUnits.UNITLESS})
                )
                om.add_variable(
                ...
                om.add_variable(
                    "leaf_area_index", crop.data.leaf_area_index, dict(info_map, **{"units": MeasurementUnits.UNITLESS})
                )
                om.add_variable(
                    "canopy_height", crop.data.canopy_height, dict(info_map, **{"units": MeasurementUnits.METERS})
                )
                om.add_variable(
                    "leaf_area_added", crop.data.leaf_area_added, dict(info_map, **{"units": MeasurementUnits.UNITLESS})
                )
                om.add_variable(
                ...
                om.add_variable(
                    "canopy_water", crop.data.canopy_water, dict(info_map, **{"units": MeasurementUnits.MILLIMETERS})
                )
                om.add_variable(
                    "cut_biomass",
