...
class EmissionsEstimator:
            ...
            if len(applied_crops) > 0:
                ...
                for i, crop in enumerate(sorted_crops):
                    ...
                    if i + 1 < len(sorted_crops):
                        ...
                        next_crop_planting_date = self._get_date(next_crop['planting_year'],
                        ...
                        if crop_harvest_date < fertilizer_application_date < next_crop_planting_date:
                            ...
                            next_crop["nitrogen_fertilizer_embedded_CO2_emissions"] = (
                                fertilizer_application["nitrogen"]
                            ...
                            next_crop["phosphorus_fertilizer_embedded_CO2_emissions"] = (
                                fertilizer_application["phosphorus"]
                            ...
                            next_crop["potassium_fertilizer_embedded_CO2_emissions"] = (
                                fertilizer_application["potassium"]
                                * EMBEDDED_POTASSIUM_FERTILIZER_EMISSIONS_FACTOR
                            )
                            applied = True
                            break
            if not applied:
                om.add_warning("Fertilizer application not associated with any crops.",
    ...
    def _partition_applied_crop_fertilizer_emissions(self, fertilizer_application: dict[str, float],
                                                     applied_crops: list[dict[str, Any]]) -> None:
    ...
    def _extract_applied_crops(self, sorted_crops: list[dict[str, Any]], fertilizer_application_date: date
                               ) -> list[dict[str, Any]]:
