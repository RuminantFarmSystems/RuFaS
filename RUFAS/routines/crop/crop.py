...
def daily_crop_routine(crop, weather, time, soil):
    ...
    if crop_type.crop_name != 'null':
        ...
        if crop_type.planted and crop_type.growing:
...
class Alfalfa:
    ...
    def __init__(self, data):
        ...
        self.harvest_type = alfalfa_data['harvest_type']
