...
def daily_nitrogen_cycling_routine(soil, time, weather):
    daily_soil_nitrogen(soil, time.julian_day(), time.y,
                        float(weather.rainfall[time.y-1][time.julian_day()-1])) 
...
def daily_nitrogen_update(soil, time, weather):
    daily_soil_nitrogen_update(soil, time.julian_day(), time.y, 
                    float(weather.addedN[time.y-1][time.julian_day()-1]))   
