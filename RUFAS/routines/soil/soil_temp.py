...
# temperature. "pseudocode_SC_soiltemperature.docx" 1.A.1
#
def calc_Tsoil(soil, weather, time):
    ...
    for x in range(0, len(soil.listOfSoilLayers)):
        ...
        # "pseudocode_SC_soiltemperature.docx" 1.A.3
        zd = z / dd

        # "pseudocode_SC_soiltemperature.docx" 1.A.2
        df_exp = exp(-0.867 - 2.078 * zd)
        df = zd / (zd + df_exp)

        # "pseudocode_SC_soiltemperature.docx" 1.A.1
...
# "pseudocode_SC_soiltemperature.docx" 1.A.5
#
def calc_scale(soil):
...
# surface. "pseudocode_SC_soiltemperature.docx" 1.A.13
#
...
# "pseudocode_SC_soiltemperature.docx" 1.A.7
#
...
# "pseudocode_SC_soiltemperature.docx" 1.A.8
#
...
def calc_albedo(soil, crop):
    ...
    # "pseudocode_SC_soiltemperature.docx" 1.A.9
    return 0.23 * (1 - cover) + albedoSoil * cover


#
# Calculates the weighting factor for ground cover
# "pseudocode_SC_soiltemperature.docx" 1.A.11/12
#
