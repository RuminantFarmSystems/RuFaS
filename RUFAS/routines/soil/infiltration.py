...
# "pseudocode_SC_soilhydrology.docx" 1.A.1
#
def calc_Q(soil, weather, time):
    ...
    # "pseudocode_SC_soilhydrology.docx" 1.A.9
...
# runoff (mm H20)
# "pseudocode_SC_soilhydrology.docx" 1.A.4
#
def calc_S(soil):
    CN3 = calc_CN3(soil)
...
# "pseudocode_SC_soilhydrology.docx" 1.A.2
#
def calc_CN1(soil):
    CN2 = soil.CN2
...
# "pseudocode_SC_soilhydrology.docx" 1.A.3
#
def calc_CN3(soil):
    CN2 = soil.CN2
...
# "pseudocode_SC_soilhydrology.docx" 1.A.5
#
def calc_Smax(soil):
    CN1 = calc_CN1(soil)
...
# "pseudocode_SC_soilhydrology.docx" 1.A.6
#
...
# "pseudocode_SC_soilhydrology.docx" 1.A.7
#
...
# "pseudocode_SC_soilhydrology.docx" 1.A.8
#
def calc_S3(CN3):
...
#
# Calculates soil water content of the entire profile
# "pseudocode_SC_soilhydrology.docx" 1.A.4
#
def sum_SW(soil):
    SW = 0.0
