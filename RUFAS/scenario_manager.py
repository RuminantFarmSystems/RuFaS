...
METADATA_PATHS: List[MetadataPaths] = [{"prefix": "run1of4_c1f4_scenario",
                                        "path": Path('input/metadata/c1f4_metadata.json')},
                                        {"prefix": "run2of4_c1f4_scenario",
                                        "path": Path('input/metadata/c1f4_metadata.json')},
                                        {"prefix": "run3of4_c1f4_scenario",
                                        "path": Path('input/metadata/c1f4_metadata.json')},
                                        {"prefix": "run4of4_c1f4_scenario",
                                        "path": Path('input/metadata/c1f4_metadata.json')},
                                       ]
