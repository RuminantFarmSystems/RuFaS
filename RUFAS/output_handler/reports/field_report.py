    ...
    class SoilCarbonReport(BaseFieldReport):
        def __init__(self, data, field_name):
            ...
            self.daily_variables = {'year': ['time.calendar_year', '', []],
                                    ...
                                    # 'bio_N': ['crop_type.bio_N', '', []],
                                    # 'bio_actual': ['crop_type.biomass_actual', '', []],
                                    # 'LN_ratio_AG': ['soil.LN_ratio_AG', '', []],
                                    # 'LN_ratio_BG': ['soil.LN_ratio_BG', '', []],
                                    # 'LN_ratio_AG+BG': ['soil.LN_ratio_AG_BG', '', []]

                                    # 'struct_AG_to_active_loss_L1': ['soil.soil_layers[0].struct_AG_to_active_loss',
                                    # '',[]], 'struct_AG_to_active_loss_L2': ['soil.soil_layers[
                                    # 1].struct_AG_to_active_loss', '',[]], 'struct_AG_to_active_loss_L3': [
                                    # 'soil.soil_layers[2].struct_AG_to_active_loss', '',[]],
                                    # 'struct_AG_to_active_actual_L1': ['soil.soil_layers[
                                    # 0].struct_AG_to_active_actual','', []], 'struct_AG_to_active_actual_L2': [
                                    # 'soil.soil_layers[1].struct_AG_to_active_actual','', []],
                                    # 'struct_AG_to_active_actual_L3': ['soil.soil_layers[
                                    # 2].struct_AG_to_active_actual','', []], 'struct_AG_to_slow_loss_L1': [
                                    # 'soil.soil_layers[0].struct_AG_to_slow_loss', '',[]],
                                    # 'struct_AG_to_slow_loss_L2': ['soil.soil_layers[1].struct_AG_to_slow_loss', '',
                                    # []], 'struct_AG_to_slow_loss_L3': ['soil.soil_layers[
                                    # 2].struct_AG_to_slow_loss', '',[]], 'struct_AG_to_slow_actual_L1': [
                                    # 'soil.soil_layers[0].struct_AG_to_slow_actual','', []],
                                    # 'struct_AG_to_slow_actual_L2': ['soil.soil_layers[1].struct_AG_to_slow_actual',
                                    # '', []], 'struct_AG_to_slow_actual_L3': ['soil.soil_layers[
                                    # 2].struct_AG_to_slow_actual','', []], 'metabolic_BG_to_active_loss_L1': [
                                    # 'soil.soil_layers[0].metabolic_BG_to_active_loss', '', []],
                                    # 'metabolic_BG_to_active_loss_L2': ['soil.soil_layers[
                                    # 1].metabolic_BG_to_active_loss', '', []], 'metabolic_BG_to_active_loss_L3': [
                                    # 'soil.soil_layers[2].metabolic_BG_to_active_loss', '', []],
                                    # 'metabolic_BG_to_active_actual_L1': ['soil.soil_layers[
                                    # 0].metabolic_BG_to_active_actual', '', []], 'metabolic_BG_to_active_actual_L2':
                                    # ['soil.soil_layers[1].metabolic_BG_to_active_actual', '', []],
                                    # 'metabolic_BG_to_active_actual_L3': ['soil.soil_layers[
                                    # 2].metabolic_BG_to_active_actual', '', []], 'struct_BG_to_active_loss_L1': [
                                    # 'soil.soil_layers[0].struct_BG_to_active_loss', '', []],
                                    # 'struct_BG_to_active_loss_L2': ['soil.soil_layers[1].struct_BG_to_active_loss',
                                    # '', []], 'struct_BG_to_active_loss_L3': ['soil.soil_layers[
                                    # 2].struct_BG_to_active_loss', '', []], 'struct_BG_to_active_actual_L1': [
                                    # 'soil.soil_layers[0].struct_BG_to_active_actual', '', []],
                                    # 'struct_BG_to_active_actual_L2': ['soil.soil_layers[
                                    # 1].struct_BG_to_active_actual', '', []], 'struct_BG_to_active_actual_L3': [
                                    # 'soil.soil_layers[2].struct_BG_to_active_actual', '', []],
                                    # 'struct_BG_to_slow_loss_L1': ['soil.soil_layers[0].struct_BG_to_slow_loss', '',
                                    # []], 'struct_BG_to_slow_loss_L2': ['soil.soil_layers[
                                    # 1].struct_BG_to_slow_loss', '', []], 'struct_BG_to_slow_loss_L3': [
                                    # 'soil.soil_layers[2].struct_BG_to_slow_loss', '', []],
                                    # 'struct_BG_to_slow_actual_L1': ['soil.soil_layers[0].struct_BG_to_slow_actual',
                                    # '', []], 'struct_BG_to_slow_actual_L2': ['soil.soil_layers[
                                    # 1].struct_BG_to_slow_actual', '', []], 'struct_BG_to_slow_actual_L3': [
                                    # 'soil.soil_layers[2].struct_BG_to_slow_actual', '', []], 'active_to_slow_L1': [
                                    # 'soil.soil_layers[0].active_to_slow', '', []], 'active_to_slow_L2': [
                                    # 'soil.soil_layers[1].active_to_slow', '', []], 'active_to_slow_L3': [
                                    # 'soil.soil_layers[2].active_to_slow', '', []], 'carbon_active_loss_L1': [
                                    # 'soil.soil_layers[0].carbon_active_loss', '', []], 'carbon_active_loss_L2': [
                                    # 'soil.soil_layers[1].carbon_active_loss', '', []], 'carbon_active_loss_L3': [
                                    # 'soil.soil_layers[2].carbon_active_loss', '', []], 'active_to_passive_L1': [
                                    # 'soil.soil_layers[0].active_to_passive', '', []], 'active_to_passive_L2': [
                                    # 'soil.soil_layers[1].active_to_passive', '', []], 'active_to_passive_L3': [
                                    # 'soil.soil_layers[2].active_to_passive', '', []], 'slow_to_active_L1': [
                                    # 'soil.soil_layers[0].slow_to_active', '', []], 'slow_to_active_L2': [
                                    # 'soil.soil_layers[1].slow_to_active', '', []], 'slow_to_active_L3': [
                                    # 'soil.soil_layers[2].slow_to_active', '', []], 'carbon_slow_loss_L1': [
                                    # 'soil.soil_layers[0].carbon_slow_loss', '', []], 'carbon_slow_loss_L2': [
                                    # 'soil.soil_layers[1].carbon_slow_loss', '', []], 'carbon_slow_loss_L3': [
                                    # 'soil.soil_layers[2].carbon_slow_loss', '', []], 'slow_to_passive_L1': [
                                    # 'soil.soil_layers[0].slow_to_passive', '', []], 'slow_to_passive_L2': [
                                    # 'soil.soil_layers[1].slow_to_passive', '', []], 'slow_to_passive_L3': [
                                    # 'soil.soil_layers[2].slow_to_passive', '', []], 'passive_to_active_L1': [
                                    # 'soil.soil_layers[0].passive_to_active', '', []], 'passive_to_active_L2': [
                                    # 'soil.soil_layers[1].passive_to_active', '', []], 'passive_to_active_L3': [
                                    # 'soil.soil_layers[2].passive_to_active', '', []], 'carbon_passive_loss_L1': [
                                    # 'soil.soil_layers[0].carbon_passive_loss', '', []], 'carbon_passive_loss_L2': [
                                    # 'soil.soil_layers[1].carbon_passive_loss', '', []], 'carbon_passive_loss_L3': [
                                    # 'soil.soil_layers[2].carbon_passive_loss', '', []],
