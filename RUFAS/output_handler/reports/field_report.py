    ...
    class SoilNitrogenReport(BaseFieldReport):
        def __init__(self, data, field_name):
            ...
            self.daily_variables = {'year': ['time.calendar_year', '', []],
                                    ...
                                    'Volatil_L1': ['soil.soil_layers[0].volatilization', 'kg/ha', []],
                                    'volatil_L2': ['soil.soil_layers[1].volatilization', 'kg/ha', []],
                                    'volatil_L3': ['soil.soil_layers[2].volatilization', 'kg/ha', []],
                                    ...
                                    'nitri_volatil_L1': ['soil.soil_layers[0].nitri_volatil', 'kg/ha', []],
                                    'nitri_volatil_L2': ['soil.soil_layers[1].nitri_volatil', 'kg/ha', []],
                                    'nitri_volatil_L3': ['soil.soil_layers[2].nitri_volatil', 'kg/ha', []],
            ...
            self.annual_variables = {'year': ['time.calendar_year', '', 0],
                                     ...
                                     'NO3_L1': ['soil.soil_layers[0].NO3_average', 'kg/ha', 0],
                                     'NO3_L2': ['soil.soil_layers[1].NO3_average', 'kg/ha', 0],
                                     'NO3_L3': ['soil.soil_layers[2].NO3_average', 'kg/ha', 0],
                                     # 'NO3_L4': ['soil.soil_layers[3].NO3_average', 'kg/ha', 0],
                                     'NH4_L1': ['soil.soil_layers[0].NH4_average', 'kg/ha', 0],
                                     'NH4_L2': ['soil.soil_layers[1].NH4_average', 'kg/ha', 0],
                                     'NH4_L3': ['soil.soil_layers[2].NH4_average', 'kg/ha', 0],
                                     # 'NH4_L4': ['soil.soil_layers[3].NH4_average', 'kg/ha', 0],
                                     'active_N_L1': ['soil.soil_layers[0].active_N_average', 'kg/ha', 0],
                                     'active_N_L2': ['soil.soil_layers[1].active_N_average', 'kg/ha', 0],
                                     'active_N_L3': ['soil.soil_layers[2].active_N_average', 'kg/ha', 0],
                                     # 'active_N_L4': ['soil.soil_layers[3].active_N_average', 'kg/ha', 0],
                                     'stable_N_L1': ['soil.soil_layers[0].stable_N_average', 'kg/ha', 0],
                                     'stable_N_L2': ['soil.soil_layers[1].stable_N_average', 'kg/ha', 0],
                                     'stable_N_L3': ['soil.soil_layers[2].stable_N_average', 'kg/ha', 0],
                                     # 'stable_N_L4': ['soil.soil_layers[3].stable_N_average', 'kg/ha', 0],
                                     'fresh_N': ['soil.fresh_N_average', 'kg', 0],
                                     'org_N_L1': ['soil.soil_layers[0].org_N_average', 'kg/ha', 0],
                                     'org_N_L2': ['soil.soil_layers[1].org_N_average', 'kg/ha', 0],
                                     'org_N_L3': ['soil.soil_layers[2].org_N_average', 'kg/ha', 0],
                                     # 'org_N_L4': ['soil.soil_layers[3].org_N_average', 'kg/ha', 0],
