        ...
        class LayerReport(BaseLayerReport):
            def __init__(self, data, field_name, layer_no):
                ...
                self.daily_variables = {
                    ...
                    'soil_C_percent': ['layer.C_percent', '%', []],
                    'total_CO2_C_loss': ['layer.C_CO2_loss', 'kg/ha', []],
                    'total_carbon': ['layer.C', 'kg/ha', []],
                    'M_d': ['layer.M_d', '', []],
    ...
    class SoilCarbonReport(BaseFieldReport):
        def __init__(self, data, field_name):
            ...
            self.daily_variables = {'year': ['time.calendar_year', '', []],
                                    ...
                                    'residue_harvest': ['soil.residue_harvest', 'kg/ha', []],
                                    'bio_BG': ['crop_type.bio_BG', 'kg/ha', []],
                                    'soil_C_percent_L1': ['soil.soil_layers[0].C_percent', '', []],
                                    'soil_C_percent_L2': ['soil.soil_layers[1].C_percent', '', []],
                                    'soil_C_percent_L3': ['soil.soil_layers[2].C_percent', '', []],
                                    'total_CO2_C_loss_L1': ['soil.soil_layers[0].C_CO2_loss', 'kg/ha', []],
                                    'total_CO2_C_loss_L2': ['soil.soil_layers[1].C_CO2_loss', 'kg/ha', []],
                                    'total_CO2_C_loss_L3': ['soil.soil_layers[2].C_CO2_loss', 'kg/ha', []],
                                    'total_carbon_L1': ['soil.soil_layers[0].C', 'kg/ha', []],
                                    'total_carbon_L2': ['soil.soil_layers[1].C', 'kg/ha', []],
                                    'total_carbon_L3': ['soil.soil_layers[2].C', 'kg/ha', []],
                                    # 'M_d_L1': ['soil.soil_layers[0].M_d', '', []],
                                    # 'M_d_L2': ['soil.soil_layers[1].M_d', '', []],
                                    # 'M_d_L3': ['soil.soil_layers[2].M_d', '', []],
                                    # 'T_d': ['soil.T_d', '', []],
                                    'fr_tillage_L1': ['soil.soil_layers[0].tillage_percent', '', []],
                                    'fr_N': ['crop_type.fr_N', '', []],
                                    ...
                                    'precipitation': ['weather.rainfall[time.year - 1][time.day - 1]', 'mm', []],
                                    'active_L1': ['soil.soil_layers[0].C_active', 'kg/ha', []],
                                    'active_L2': ['soil.soil_layers[1].C_active', 'kg/ha', []],
                                    'active_L3': ['soil.soil_layers[2].C_active', 'kg/ha', []],
                                    'slow_L1': ['soil.soil_layers[0].C_slow', 'kg/ha', []],
                                    'slow_L2': ['soil.soil_layers[1].C_slow', 'kg/ha', []],
                                    'slow_L3': ['soil.soil_layers[2].C_slow', 'kg/ha', []],
                                    'passive_L1': ['soil.soil_layers[0].C_passive', 'kg/ha', []],
                                    'passive_L2': ['soil.soil_layers[1].C_passive', 'kg/ha', []],
                                    'passive_L3': ['soil.soil_layers[2].C_passive', 'kg/ha', []]
                                    }
