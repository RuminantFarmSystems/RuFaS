...
def daily_simulation():
    ...
    routines.daily_manure_management_routine(state.manure_management, state.animal_management)
    routines.daily_fields_routine(state.fields, state.manure_management, weather, time)
