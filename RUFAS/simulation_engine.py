...
from RUFAS.routines.manure_management.manure_management import daily_manure_management_routine
...
class SimulationEngine:
    ...
    def _daily_simulation(self) -> None:
        ...
        daily_manure_management_routine(self.state.manure_management, self.state.animal_management)
