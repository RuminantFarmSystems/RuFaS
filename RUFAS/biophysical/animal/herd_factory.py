...
class HerdFactory:
    ...
    def _random_sample_with_replacement_by_type(self, animal_type: str) -> list[Animal]:
        ...
        PRE_ANIMAL_DATA: dict[str, list[Animal]] = {
            ...
            "cows_parity_1_milking": self.pre_animal_population.get_cows_by_parity_and_milking(1, True),
            "cows_parity_2_milking": self.pre_animal_population.get_cows_by_parity_and_milking(2, True),
            "cows_parity_3_milking": self.pre_animal_population.get_cows_by_parity_and_milking(3, True),
            "cows_parity_4_milking": self.pre_animal_population.get_cows_by_parity_and_milking(4, True),
            "cows_parity_5_milking": self.pre_animal_population.get_cows_by_parity_and_milking(5, True),
            "cows_parity_1_not_milking": self.pre_animal_population.get_cows_by_parity_and_milking(1, False),
            "cows_parity_2_not_milking": self.pre_animal_population.get_cows_by_parity_and_milking(2, False),
            "cows_parity_3_not_milking": self.pre_animal_population.get_cows_by_parity_and_milking(3, False),
            "cows_parity_4_not_milking": self.pre_animal_population.get_cows_by_parity_and_milking(4, False),
            "cows_parity_5_not_milking": self.pre_animal_population.get_cows_by_parity_and_milking(5, False),
