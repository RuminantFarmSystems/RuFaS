...
@dataclass
class EnergyNutritionEvaluation:
    """
    ...
    dry_matter : float
        ...
        this value is 0.0.
    ndf : float
        Percentage of NDF by which a ration was outside the acceptable bounds. If NDF was acceptable, this valus is 0.0.
    fat : float
    ...
    def is_valid_heifer_ration(self) -> bool:
        """True if evaluated supply meet the requirements, else false."""
