...
class EntericMethaneCalculator:
    ...
    @staticmethod
    def cow_methane(is_lactating: bool,
                    body_weight: float,
                    milk_fat: float,
        ...
        if is_lactating:
            ...
            methane_emission = EntericMethaneCalculator._dry_cow_manure(methane_model,
                                                                        metabolizable_energy_intake,
                                                                        nutrient_amounts,
                                                                        nutrient_concentrations)
    ...
    def _lactating_cow_manure(body_weight: float, milk_fat: float, metabolizable_energy_intake: float,
                              nutrient_amounts: dict[str, float], nutrient_concentrations: dict[str, float],
                              methane_model: str) -> float:
        """
    ...
    @staticmethod
    def _dry_cow_manure(methane_model: str, metabolizable_energy_intake: float,
                        nutrient_amounts: dict[str, float], nutrient_concentrations: dict[str, float]) -> float:
        """
