...
- [3077](https://github.com/RuminantFarmSystems/RuFaS/pull/3077) - [minor change] [Animal] [NoInputChange] [OutputChange] Add daily reporting of successful conceptions at the herd, heifer, and cow level (`num_successful_conceptions`, `heiferII_num_successful_conceptions`, `cow_num_successful_conceptions`), enabling per-year and other period slicing for downstream analyses.
