...
- [2009](https://github.com/RuminantFarmSystems/MASM/pull/2009) - [minor change] [Manure] Adds a method to determine storage manure temperature based on outdoor air temperature for use in calculations of emissions associated with Manure Storages.