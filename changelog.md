...
- [3099](https://github.com/RuminantFarmSystems/RuFaS/pull/3099) - [minor change] [Animal] [NoInputChange] [NoOutputChange] Adds warning in `HerdManager.formulate_rations()` when milk production is reduced and reports the number of affected cows with the average reduction in kg.
