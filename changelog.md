...
- [3050](https://github.com/RuminantFarmSystems/RuFaS/pull/3050) - [minor change] [FieldManager] [SimulationEngine] [NoInputChange] [NoOutputChange] Moves field config data gathering out of `FieldManager.__init__()` into `SimulationEngine`, passing field data as a parameter instead.
