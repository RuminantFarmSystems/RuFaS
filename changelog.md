...
- [2019](https://github.com/RuminantFarmSystems/MASM/pull/2019) - [minor change] [Animal] **Adds dependency**. Creates a new `MilkProduction` submodule and several support submodules to calculate milk production.
