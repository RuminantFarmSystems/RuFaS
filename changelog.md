...
- [1784](https://github.com/RuminantFarmSystems/MASM/pull/1784) - [minor change] [Testing] Adds end-to-end testing routine for the Feed Storage module which can be extended to test other parts of RuFaS.