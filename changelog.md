...
- [2678](https://github.com/RuminantFarmSystems/MASM/pull/2678) - [minor change] [Manure] [NoInputChange] [NoOutputChange] Corrects a bug in Separators and adds a check to prevent a bug in Slurry Storage Outdoor, Slurry Storage Underfloor, and Anaerobic Lagoon.
- [2679](https://github.com/RuminantFarmSystems/MASM/pull/2678) - [minor change] [Feed] [NoInputChange] [OutputChange] Removes default reporting 0.0s for FGFs that aren't grown during a simulation
