...
* Names of module entities are poorly selected and unintuitive. 
...
Below is a detailed example of a how `FieldDirector` might behave for a system with 3 fields over a
...
Below is a bulleted list of format/organization guidelines that the Soil and Crop module will
follow:
