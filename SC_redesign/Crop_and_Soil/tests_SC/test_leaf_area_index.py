...
# TODO: all tests of member functions will need to be move into the test_grow_canopy function
...
#     lai.determine_max_leaf_area_change(frac, prev_frac, max_lai, prev_lai)
#     assert lai.max_leaf_area_change == LeafAreaIndex.determine_max_leaf_area_change(frac, prev_frac, max_lai, prev_lai)
#
