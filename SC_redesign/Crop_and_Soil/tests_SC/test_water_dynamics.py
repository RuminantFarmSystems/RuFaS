...
def test_calc_evapotranspiration(evap, trans):
    ...
    assert WaterDynamics.calc_evapotranspiration(evap, trans) == evap + trans
...
def test_calc_water_deficiency(et, max_et):
    ...
    assert WaterDynamics.calc_water_deficiency(et, max_et) == expect
...
def test_update_evapotranspiration(evap, trans):
    ...
    assert water_dyn.evapotranspiration == WaterDynamics.calc_evapotranspiration(evap, trans)
...
def test_assess_water_deficiency(et, max_et):
    ...
    assert water_dyn.water_deficiency == WaterDynamics.calc_water_deficiency(et, max_et)
...
def test_cycle_water(evap, trans, et_max):
    ...
    observed = [evap, trans, evap+trans, et_max, WaterDynamics.calc_water_deficiency(evap+trans, et_max)]
