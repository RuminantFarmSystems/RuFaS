...
def test_water_factor(soil_water_content: float, field_capacity_content: float, wilting_point_content: float,
    ...
    with patch('SC_redesign.Crop_and_Soil.soil.layer_data.LayerData.soil_water_content',
        ...
        with patch('SC_redesign.Crop_and_Soil.soil.layer_data.LayerData.field_capacity_content',
            ...
            with patch('SC_redesign.Crop_and_Soil.soil.layer_data.LayerData.wilting_point_content',
                       new_callable=PropertyMock, return_value=wilting_point_content):
                with patch('SC_redesign.Crop_and_Soil.soil.layer_data.LayerData.saturation_content',
