...
@pytest.mark.parametrize("name,mix_names,years,days,nitrogen,phosphorus,depths,fractions,expected_err_msg", [
...
def test_validate_fertilizer_parameters(name: str, mix_names: List[str], years: List[int], days: List[int],
                                        ...
                                        fractions: List[float], expected_err_msg: str) -> None:
...
@pytest.mark.parametrize("mixes,years,days,nitrogen,phosphorus,depths,fractions,skip,repeat,expected", [
    (["mix_1"], [1990, 1993], [100], [10.0], [10.0], [30.0], [0.8], 1, 2, [
    ...
    (["mix_1", "mix_2", "mix_1"], [1991, 1991, 1992], [150, 240, 90], [15.0, 8.0, 20.0], [10.0, 10.0, 10.0], [0.0],
     [1.0], 0, 1, [
    ...
    (["mix_3", "mix_4"], [1995, 1996], [100], [10.0, 20.0], [25.0, 10.0], [0.0], [1.0], 0, 2, [
...
def test_generate_fertilizer_events(mixes: List[str], years: List[int], days: List[int], nitrogen: List[float],
                                    ...
                                    repeat: int, expected: str) -> None:
    """Tests that FertilizerEvents are properly generated by FertilizerSchedules."""
    fert_sched = FertilizerSchedule("test", mixes, years, days, nitrogen, phosphorus, depths, fractions, skip, repeat)
