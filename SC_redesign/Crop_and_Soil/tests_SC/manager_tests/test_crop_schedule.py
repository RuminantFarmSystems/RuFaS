...
@pytest.mark.parametrize("years,days,heat_scheduled,skip,repeat,expected", [
    ([1, 3, 4], [120, 100, 100], False, 1, 2, [PlantingEvent("test", 1, 120, False),
    ...
    ([2, 4], [115, 115], True, 2, 3, [PlantingEvent("test", 2, 115, True), PlantingEvent("test", 4, 115, True),
                                      PlantingEvent("test", 7, 115, True), PlantingEvent("test", 9, 115, True),
                                      PlantingEvent("test", 10, 115, True), PlantingEvent("test", 12, 115, True)]),
    ([1, 2, 5], [120, 120, 110], False, 3, 0, [PlantingEvent("test", 1, 120, False),
