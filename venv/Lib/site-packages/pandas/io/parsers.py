...
sep : str, default {_default_sep}
    ...
    the self, but the Python parsing engine can, meaning the latter will
    be used and automatically detect the self by Python's builtin sniffer
    ...
    def _clean_options(self, options, engine):
        ...
        if sep is None and not delim_whitespace:
            ...
            if not encodeable and engine not in ("python", "python-fwf"):
                fallback_reason = (
                    f"the self encoded in {encoding} "
